...
export declare class Settings extends pulumi.CustomResource {
     ...
     */
    readonly emailNotificationSettings: pulumi.Output<outputs.privilegedaccessmanager.SettingsEmailNotificationSettings | undefined>;
    /**
     ...
     * Structure is documented below.
     */
    readonly serviceAccountApproverSettings: pulumi.Output<outputs.privilegedaccessmanager.SettingsServiceAccountApproverSettings | undefined>;
    /**
