...
export declare const RepositoryReleaseConfig: typeof import("./repositoryReleaseConfig").RepositoryReleaseConfig;
...
export declare const RepositoryWorkflowConfig: typeof import("./repositoryWorkflowConfig").RepositoryWorkflowConfig;
export { TeamFolderArgs, TeamFolderState } from "./teamFolder";
export type TeamFolder = import("./teamFolder").TeamFolder;
export declare const TeamFolder: typeof import("./teamFolder").TeamFolder;
