 ...
 * ```
 */
export declare class TeamFolder extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TeamFolderState, opts?: pulumi.CustomResourceOptions): TeamFolder;
    /**
     * Returns true if the given object is an instance of TeamFolder.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TeamFolder;
    /**
     ...
     */
    readonly teamfolderId: pulumi.Output<string>;
    /**
