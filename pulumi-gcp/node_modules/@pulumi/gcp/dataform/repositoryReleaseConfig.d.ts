 ...
 * ```
 */
export declare class RepositoryReleaseConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryReleaseConfigState, opts?: pulumi.CustomResourceOptions): RepositoryReleaseConfig;
    /**
     * Returns true if the given object is an instance of RepositoryReleaseConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RepositoryReleaseConfig;
    /**
     ...
     */
    readonly codeCompilationConfig: pulumi.Output<outputs.dataform.RepositoryReleaseConfigCodeCompilationConfig | undefined>;
    /**
     ...
     */
    readonly gitCommitish: pulumi.Output<string>;
    /**
     * The release's name.
     */
     ...
     * Structure is documented below.
     */
    readonly recentScheduledReleaseRecords: pulumi.Output<outputs.dataform.RepositoryReleaseConfigRecentScheduledReleaseRecord[]>;
    /**
