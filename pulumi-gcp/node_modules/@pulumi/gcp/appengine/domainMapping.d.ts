 ...
 * ```
 */
export declare class DomainMapping extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainMappingState, opts?: pulumi.CustomResourceOptions): DomainMapping;
    /**
     * Returns true if the given object is an instance of DomainMapping.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DomainMapping;
    /**
     ...
     */
    readonly overrideStrategy: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly resourceRecords: pulumi.Output<outputs.appengine.DomainMappingResourceRecord[]>;
    /**
     * SSL configuration for this domain. If unconfigured, this domain will not serve with SSL.
     * Structure is documented below.
     */
    readonly sslSettings: pulumi.Output<outputs.appengine.DomainMappingSslSettings>;
    /**
