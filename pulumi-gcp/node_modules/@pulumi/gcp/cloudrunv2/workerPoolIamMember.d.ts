 ...
 */
export declare class WorkerPoolIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkerPoolIamMemberState, opts?: pulumi.CustomResourceOptions): WorkerPoolIamMember;
    /**
     * Returns true if the given object is an instance of WorkerPoolIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkerPoolIamMember;
    readonly condition: pulumi.Output<outputs.cloudrunv2.WorkerPoolIamMemberCondition | undefined>;
    /**
