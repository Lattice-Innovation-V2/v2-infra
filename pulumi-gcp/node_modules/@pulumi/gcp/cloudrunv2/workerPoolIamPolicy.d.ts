 ...
 */
export declare class WorkerPoolIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkerPoolIamPolicyState, opts?: pulumi.CustomResourceOptions): WorkerPoolIamPolicy;
    /**
     * Returns true if the given object is an instance of WorkerPoolIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkerPoolIamPolicy;
    /**
