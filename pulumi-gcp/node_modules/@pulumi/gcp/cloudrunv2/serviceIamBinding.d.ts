...
export declare class ServiceIamBinding extends pulumi.CustomResource {
    ...
    readonly condition: pulumi.Output<outputs.cloudrunv2.ServiceIamBindingCondition | undefined>;
    /**
...
export interface ServiceIamBindingState {
    condition?: pulumi.Input<inputs.cloudrunv2.ServiceIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
