 ...
 */
export declare class WorkerPoolIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing WorkerPoolIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkerPoolIamBindingState, opts?: pulumi.CustomResourceOptions): WorkerPoolIamBinding;
    /**
     * Returns true if the given object is an instance of WorkerPoolIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkerPoolIamBinding;
    readonly condition: pulumi.Output<outputs.cloudrunv2.WorkerPoolIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a WorkerPoolIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: WorkerPoolIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering WorkerPoolIamBinding resources.
 */
export interface WorkerPoolIamBindingState {
    condition?: pulumi.Input<inputs.cloudrunv2.WorkerPoolIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface WorkerPoolIamBindingArgs {
    condition?: pulumi.Input<inputs.cloudrunv2.WorkerPoolIamBindingCondition>;
    /**
     * The location of the cloud run worker pool Used to find the parent resource to bind the IAM policy to. If not specified,
     * the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
