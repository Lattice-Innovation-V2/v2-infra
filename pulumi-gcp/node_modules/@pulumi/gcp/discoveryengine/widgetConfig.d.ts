 ...
 * ```
 */
export declare class WidgetConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WidgetConfigState, opts?: pulumi.CustomResourceOptions): WidgetConfig;
    /**
     * Returns true if the given object is an instance of WidgetConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WidgetConfig;
    /**
     * Describes widget access settings.
     * Structure is documented below.
     */
    readonly accessSettings: pulumi.Output<outputs.discoveryengine.WidgetConfigAccessSettings>;
    /**
     * The collection ID.
     */
     ...
     * Structure is documented below.
     */
    readonly homepageSetting: pulumi.Output<outputs.discoveryengine.WidgetConfigHomepageSetting | undefined>;
    /**
     ...
     * Structure is documented below.
     */
    readonly uiBranding: pulumi.Output<outputs.discoveryengine.WidgetConfigUiBranding | undefined>;
    /**
     * Describes general widget (or web app) UI settings as seen in the cloud console UI configuration page.
     * Structure is documented below.
     */
    readonly uiSettings: pulumi.Output<outputs.discoveryengine.WidgetConfigUiSettings>;
    /**
     * The unique ID to use for the WidgetConfig. Currently only accepts "defaultSearchWidgetConfig".
     */
    readonly widgetConfigId: pulumi.Output<string | undefined>;
    /**
