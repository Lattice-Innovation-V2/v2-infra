 ...
 * ```
 */
export declare class RecommendationEngine extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RecommendationEngineState, opts?: pulumi.CustomResourceOptions): RecommendationEngine;
    /**
     * Returns true if the given object is an instance of RecommendationEngine.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RecommendationEngine;
    /**
     * Common config spec that specifies the metadata of the engine.
     * Structure is documented below.
     */
    readonly commonConfig: pulumi.Output<outputs.discoveryengine.RecommendationEngineCommonConfig | undefined>;
    /**
     ...
     * Structure is documented below.
     */
    readonly mediaRecommendationEngineConfig: pulumi.Output<outputs.discoveryengine.RecommendationEngineMediaRecommendationEngineConfig | undefined>;
    /**
