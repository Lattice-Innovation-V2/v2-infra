...
export declare class Assistant extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AssistantState, opts?: pulumi.CustomResourceOptions): Assistant;
    /**
     ...
     */
    readonly customerPolicy: pulumi.Output<outputs.discoveryengine.AssistantCustomerPolicy | undefined>;
    /**
     ...
     * Structure is documented below.
     */
    readonly generationConfig: pulumi.Output<outputs.discoveryengine.AssistantGenerationConfig | undefined>;
    /**
