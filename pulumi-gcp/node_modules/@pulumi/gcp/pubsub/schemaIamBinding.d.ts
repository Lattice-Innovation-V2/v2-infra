 ...
 */
export declare class SchemaIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SchemaIamBindingState, opts?: pulumi.CustomResourceOptions): SchemaIamBinding;
    /**
     * Returns true if the given object is an instance of SchemaIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SchemaIamBinding;
    readonly condition: pulumi.Output<outputs.pubsub.SchemaIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a SchemaIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: SchemaIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SchemaIamBinding resources.
 */
export interface SchemaIamBindingState {
    condition?: pulumi.Input<inputs.pubsub.SchemaIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface SchemaIamBindingArgs {
    condition?: pulumi.Input<inputs.pubsub.SchemaIamBindingCondition>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
