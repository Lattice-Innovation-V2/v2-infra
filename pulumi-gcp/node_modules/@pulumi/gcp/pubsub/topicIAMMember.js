...
class TopicIAMMember extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new TopicIAMMember(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(TopicIAMMember.__pulumiType, name, resourceInputs, opts);
    }
}
exports.TopicIAMMember = TopicIAMMember;
/** @internal */
TopicIAMMember.__pulumiType = 'gcp:pubsub/topicIAMMember:TopicIAMMember';
//# sourceMappingURL=topicIAMMember.js.map