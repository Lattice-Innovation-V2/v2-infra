 ...
 */
export declare class TopicIAMBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TopicIAMBindingState, opts?: pulumi.CustomResourceOptions): TopicIAMBinding;
    /**
     * Returns true if the given object is an instance of TopicIAMBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TopicIAMBinding;
    readonly condition: pulumi.Output<outputs.pubsub.TopicIAMBindingCondition | undefined>;
    /**
