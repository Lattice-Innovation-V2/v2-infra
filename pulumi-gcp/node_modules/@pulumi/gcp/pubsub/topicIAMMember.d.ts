...
export declare class TopicIAMMember extends pulumi.CustomResource {
     ...
     */
    static isInstance(obj: any): obj is TopicIAMMember;
    readonly condition: pulumi.Output<outputs.pubsub.TopicIAMMemberCondition | undefined>;
    /**
...
export interface TopicIAMMemberState {
    condition?: pulumi.Input<inputs.pubsub.TopicIAMMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
