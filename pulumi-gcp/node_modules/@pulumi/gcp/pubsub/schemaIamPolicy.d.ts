 ...
 */
export declare class SchemaIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SchemaIamPolicyState, opts?: pulumi.CustomResourceOptions): SchemaIamPolicy;
    /**
     * Returns true if the given object is an instance of SchemaIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SchemaIamPolicy;
    /**
