 ...
 * ```
 */
export declare class LiteReservation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LiteReservationState, opts?: pulumi.CustomResourceOptions): LiteReservation;
    /**
     * Returns true if the given object is an instance of LiteReservation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LiteReservation;
    /**
