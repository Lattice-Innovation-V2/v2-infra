 ...
 * ```
 */
export declare function getConfigIamPolicyOutput(args: GetConfigIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetConfigIamPolicyResult>;
/**
 * A collection of arguments for invoking getConfigIamPolicy.
 */
