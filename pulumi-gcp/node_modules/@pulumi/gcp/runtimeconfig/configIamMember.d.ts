 ...
 */
export declare class ConfigIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConfigIamMemberState, opts?: pulumi.CustomResourceOptions): ConfigIamMember;
    /**
     * Returns true if the given object is an instance of ConfigIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConfigIamMember;
    readonly condition: pulumi.Output<outputs.runtimeconfig.ConfigIamMemberCondition | undefined>;
    /**
