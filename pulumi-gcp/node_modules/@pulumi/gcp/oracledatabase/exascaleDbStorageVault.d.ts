 ...
 * ```
 */
export declare class ExascaleDbStorageVault extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExascaleDbStorageVaultState, opts?: pulumi.CustomResourceOptions): ExascaleDbStorageVault;
    /**
     * Returns true if the given object is an instance of ExascaleDbStorageVault.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExascaleDbStorageVault;
    /**
     ...
     * letter or a number.
     */
    readonly exascaleDbStorageVaultId: pulumi.Output<string>;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.oracledatabase.ExascaleDbStorageVaultProperties>;
    /**
