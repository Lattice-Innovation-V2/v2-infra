 ...
 * ```
 */
export declare class ExadbVmCluster extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExadbVmClusterState, opts?: pulumi.CustomResourceOptions): ExadbVmCluster;
    /**
     * Returns true if the given object is an instance of ExadbVmCluster.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExadbVmCluster;
    /**
     * The name of the backup OdbSubnet associated with the ExadbVmCluster.
     * Format:
     * projects/{project}/locations/{location}/odbNetworks/{odb_network}/odbSubnets/{odb_subnet}
     */
    readonly backupOdbSubnet: pulumi.Output<string>;
    /**
     ...
     * letter or a number.
     */
    readonly exadbVmClusterId: pulumi.Output<string>;
    /**
     ...
     */
    readonly properties: pulumi.Output<outputs.oracledatabase.ExadbVmClusterProperties>;
    /**
