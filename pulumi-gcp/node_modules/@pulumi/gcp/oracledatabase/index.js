    ...
    construct: (name, type, urn) => {
        switch (type) {
            ...
            case "gcp:oracledatabase/dbSystem:DbSystem":
                return new exports.DbSystem(name, undefined, { urn });
            case "gcp:oracledatabase/exadbVmCluster:ExadbVmCluster":
                return new exports.ExadbVmCluster(name, undefined, { urn });
            case "gcp:oracledatabase/exascaleDbStorageVault:ExascaleDbStorageVault":
                return new exports.ExascaleDbStorageVault(name, undefined, { urn });
