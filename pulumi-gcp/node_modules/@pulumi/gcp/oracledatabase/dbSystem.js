...
class DbSystem extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new DbSystem(name, state, { ...opts, id: id });
    }
    /**
...
exports.DbSystem = DbSystem;
/** @internal */
DbSystem.__pulumiType = 'gcp:oracledatabase/dbSystem:DbSystem';
//# sourceMappingURL=dbSystem.js.map