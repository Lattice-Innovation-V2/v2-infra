 ...
 */
export declare class DataExchangeIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataExchangeIamMemberState, opts?: pulumi.CustomResourceOptions): DataExchangeIamMember;
    /**
     * Returns true if the given object is an instance of DataExchangeIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataExchangeIamMember;
    readonly condition: pulumi.Output<outputs.bigqueryanalyticshub.DataExchangeIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: DataExchangeIamMemberArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering DataExchangeIamMember resources.
 */
export interface DataExchangeIamMemberState {
    condition?: pulumi.Input<inputs.bigqueryanalyticshub.DataExchangeIamMemberCondition>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
