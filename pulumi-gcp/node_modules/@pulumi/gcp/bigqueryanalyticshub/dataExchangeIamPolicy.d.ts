 ...
 */
export declare class DataExchangeIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataExchangeIamPolicyState, opts?: pulumi.CustomResourceOptions): DataExchangeIamPolicy;
    /**
     * Returns true if the given object is an instance of DataExchangeIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataExchangeIamPolicy;
    /**
