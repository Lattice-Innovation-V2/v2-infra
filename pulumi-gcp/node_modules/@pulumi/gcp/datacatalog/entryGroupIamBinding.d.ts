 ...
 */
export declare class EntryGroupIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EntryGroupIamBindingState, opts?: pulumi.CustomResourceOptions): EntryGroupIamBinding;
    /**
     * Returns true if the given object is an instance of EntryGroupIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EntryGroupIamBinding;
    readonly condition: pulumi.Output<outputs.datacatalog.EntryGroupIamBindingCondition | undefined>;
    /**
