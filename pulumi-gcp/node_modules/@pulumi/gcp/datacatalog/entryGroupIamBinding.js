...
exports.EntryGroupIamBinding = void 0;
...
class EntryGroupIamBinding extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new EntryGroupIamBinding(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            if (args?.entryGroup === undefined && !opts.urn) {
...
exports.EntryGroupIamBinding = EntryGroupIamBinding;
/** @internal */
EntryGroupIamBinding.__pulumiType = 'gcp:datacatalog/entryGroupIamBinding:EntryGroupIamBinding';
//# sourceMappingURL=entryGroupIamBinding.js.map