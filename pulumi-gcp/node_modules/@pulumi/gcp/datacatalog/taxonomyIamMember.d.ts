 ...
 */
export declare class TaxonomyIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TaxonomyIamMemberState, opts?: pulumi.CustomResourceOptions): TaxonomyIamMember;
    /**
     * Returns true if the given object is an instance of TaxonomyIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TaxonomyIamMember;
    readonly condition: pulumi.Output<outputs.datacatalog.TaxonomyIamMemberCondition | undefined>;
    /**
...
export interface TaxonomyIamMemberState {
    condition?: pulumi.Input<inputs.datacatalog.TaxonomyIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
