 ...
 */
export declare class TaxonomyIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TaxonomyIamPolicyState, opts?: pulumi.CustomResourceOptions): TaxonomyIamPolicy;
    /**
     * Returns true if the given object is an instance of TaxonomyIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TaxonomyIamPolicy;
    /**
