 ...
 */
export declare class TagTemplateIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TagTemplateIamPolicyState, opts?: pulumi.CustomResourceOptions): TagTemplateIamPolicy;
    /**
     * Returns true if the given object is an instance of TagTemplateIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TagTemplateIamPolicy;
    /**
