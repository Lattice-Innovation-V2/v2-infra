 ...
 */
export declare class TaxonomyIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TaxonomyIamBindingState, opts?: pulumi.CustomResourceOptions): TaxonomyIamBinding;
    /**
     * Returns true if the given object is an instance of TaxonomyIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TaxonomyIamBinding;
    readonly condition: pulumi.Output<outputs.datacatalog.TaxonomyIamBindingCondition | undefined>;
    /**
