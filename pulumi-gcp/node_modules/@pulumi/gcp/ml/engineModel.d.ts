 ...
 * ```
 */
export declare class EngineModel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EngineModelState, opts?: pulumi.CustomResourceOptions): EngineModel;
    /**
     * Returns true if the given object is an instance of EngineModel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EngineModel;
    /**
     * The default version of the model. This version will be used to handle
     * prediction requests that do not specify a version.
     * Structure is documented below.
     */
    readonly defaultVersion: pulumi.Output<outputs.ml.EngineModelDefaultVersion | undefined>;
    /**
     ...
     */
    readonly onlinePredictionConsoleLogging: pulumi.Output<boolean | undefined>;
    /**
     * If true, online prediction access logs are sent to StackDriver Logging.
     */
    readonly onlinePredictionLogging: pulumi.Output<boolean | undefined>;
    /**
