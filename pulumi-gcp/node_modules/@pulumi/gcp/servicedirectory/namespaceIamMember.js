...
exports.NamespaceIamMember = void 0;
 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
class NamespaceIamMember extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new NamespaceIamMember(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
NamespaceIamMember.__pulumiType = 'gcp:servicedirectory/namespaceIamMember:NamespaceIamMember';
//# sourceMappingURL=namespaceIamMember.js.map