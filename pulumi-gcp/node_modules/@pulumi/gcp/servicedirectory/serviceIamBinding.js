...
exports.ServiceIamBinding = void 0;
 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
class ServiceIamBinding extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ServiceIamBinding(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
ServiceIamBinding.__pulumiType = 'gcp:servicedirectory/serviceIamBinding:ServiceIamBinding';
//# sourceMappingURL=serviceIamBinding.js.map