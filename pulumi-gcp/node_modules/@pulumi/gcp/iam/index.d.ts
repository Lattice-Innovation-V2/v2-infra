...
export declare const WorkforcePoolProviderScimTenant: typeof import("./workforcePoolProviderScimTenant").WorkforcePoolProviderScimTenant;
export { WorkforcePoolProviderScimTokenArgs, WorkforcePoolProviderScimTokenState } from "./workforcePoolProviderScimToken";
export type WorkforcePoolProviderScimToken = import("./workforcePoolProviderScimToken").WorkforcePoolProviderScimToken;
export declare const WorkforcePoolProviderScimToken: typeof import("./workforcePoolProviderScimToken").WorkforcePoolProviderScimToken;
