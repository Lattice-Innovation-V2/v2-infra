 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export declare class WorkforcePoolIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkforcePoolIamMemberState, opts?: pulumi.CustomResourceOptions): WorkforcePoolIamMember;
    /**
     * Returns true if the given object is an instance of WorkforcePoolIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkforcePoolIamMember;
    readonly condition: pulumi.Output<outputs.iam.WorkforcePoolIamMemberCondition | undefined>;
    /**
