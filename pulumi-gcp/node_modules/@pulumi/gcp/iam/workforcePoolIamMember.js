...
exports.WorkforcePoolIamMember = void 0;
 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
class WorkforcePoolIamMember extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new WorkforcePoolIamMember(name, state, { ...opts, id: id });
    }
    /**
...
exports.WorkforcePoolIamMember = WorkforcePoolIamMember;
/** @internal */
WorkforcePoolIamMember.__pulumiType = 'gcp:iam/workforcePoolIamMember:WorkforcePoolIamMember';
//# sourceMappingURL=workforcePoolIamMember.js.map