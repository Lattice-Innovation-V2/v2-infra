 ...
 * ```
 */
export declare class OrganizationsPolicyBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrganizationsPolicyBindingState, opts?: pulumi.CustomResourceOptions): OrganizationsPolicyBinding;
    /**
     ...
     */
    static isInstance(obj: any): obj is OrganizationsPolicyBinding;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.iam.OrganizationsPolicyBindingCondition | undefined>;
    /**
     ...
     * Structure is documented below.
     */
    readonly target: pulumi.Output<outputs.iam.OrganizationsPolicyBindingTarget>;
    /**
