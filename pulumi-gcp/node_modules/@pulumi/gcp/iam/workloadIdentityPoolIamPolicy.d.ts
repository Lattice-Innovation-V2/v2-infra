 ...
 */
export declare class WorkloadIdentityPoolIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkloadIdentityPoolIamPolicyState, opts?: pulumi.CustomResourceOptions): WorkloadIdentityPoolIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is WorkloadIdentityPoolIamPolicy;
    /**
