 ...
 * ```
 */
export declare class BackupChannel extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackupChannelState, opts?: pulumi.CustomResourceOptions): BackupChannel;
    /**
     * Returns true if the given object is an instance of BackupChannel.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BackupChannel;
    /**
