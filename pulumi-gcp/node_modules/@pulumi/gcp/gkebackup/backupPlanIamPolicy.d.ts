 ...
 */
export declare class BackupPlanIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackupPlanIamPolicyState, opts?: pulumi.CustomResourceOptions): BackupPlanIamPolicy;
    /**
     * Returns true if the given object is an instance of BackupPlanIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BackupPlanIamPolicy;
    /**
