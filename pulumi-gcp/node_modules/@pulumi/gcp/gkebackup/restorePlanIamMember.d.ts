 ...
 */
export declare class RestorePlanIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RestorePlanIamMemberState, opts?: pulumi.CustomResourceOptions): RestorePlanIamMember;
    /**
     * Returns true if the given object is an instance of RestorePlanIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RestorePlanIamMember;
    readonly condition: pulumi.Output<outputs.gkebackup.RestorePlanIamMemberCondition | undefined>;
    /**
