 ...
 */
export declare class RestorePlanIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RestorePlanIamPolicyState, opts?: pulumi.CustomResourceOptions): RestorePlanIamPolicy;
    /**
     * Returns true if the given object is an instance of RestorePlanIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RestorePlanIamPolicy;
    /**
