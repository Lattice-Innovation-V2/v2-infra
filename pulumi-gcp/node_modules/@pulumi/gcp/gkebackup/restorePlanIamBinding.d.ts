 ...
 */
export declare class RestorePlanIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RestorePlanIamBindingState, opts?: pulumi.CustomResourceOptions): RestorePlanIamBinding;
    /**
     * Returns true if the given object is an instance of RestorePlanIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RestorePlanIamBinding;
    readonly condition: pulumi.Output<outputs.gkebackup.RestorePlanIamBindingCondition | undefined>;
    /**
