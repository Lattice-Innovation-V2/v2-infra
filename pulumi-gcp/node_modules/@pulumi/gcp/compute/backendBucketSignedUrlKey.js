...
exports.BackendBucketSignedUrlKey = void 0;
...
class BackendBucketSignedUrlKey extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new BackendBucketSignedUrlKey(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["backendBucket"] = state?.backendBucket;
            ...
            if (args?.backendBucket === undefined && !opts.urn) {
            ...
            resourceInputs["backendBucket"] = args?.backendBucket;
