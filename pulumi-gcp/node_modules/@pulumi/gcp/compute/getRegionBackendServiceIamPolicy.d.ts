 ...
 * ```
 */
export declare function getRegionBackendServiceIamPolicy(args: GetRegionBackendServiceIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionBackendServiceIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getRegionBackendServiceIamPolicyOutput(args: GetRegionBackendServiceIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegionBackendServiceIamPolicyResult>;
/**
 * A collection of arguments for invoking getRegionBackendServiceIamPolicy.
 */
