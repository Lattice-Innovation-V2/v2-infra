 ...
 * ```
 */
export declare class GlobalNetworkEndpointGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GlobalNetworkEndpointGroupState, opts?: pulumi.CustomResourceOptions): GlobalNetworkEndpointGroup;
    /**
     ...
     */
    static isInstance(obj: any): obj is GlobalNetworkEndpointGroup;
    /**
     ...
     */
    readonly networkEndpointType: pulumi.Output<string>;
    /**
