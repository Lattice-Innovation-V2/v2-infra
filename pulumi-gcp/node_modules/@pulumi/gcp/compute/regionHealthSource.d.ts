 ...
 * ```
 */
export declare class RegionHealthSource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionHealthSourceState, opts?: pulumi.CustomResourceOptions): RegionHealthSource;
    /**
     * Returns true if the given object is an instance of RegionHealthSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegionHealthSource;
    /**
     ...
     * mutated.
     */
    readonly healthAggregationPolicy: pulumi.Output<string | undefined>;
    /**
