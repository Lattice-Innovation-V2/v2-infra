 ...
 * ```
 */
export declare class RegionCompositeHealthCheck extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionCompositeHealthCheckState, opts?: pulumi.CustomResourceOptions): RegionCompositeHealthCheck;
    /**
     ...
     */
    static isInstance(obj: any): obj is RegionCompositeHealthCheck;
    /**
     ...
     */
    readonly healthDestination: pulumi.Output<string>;
    /**
     ...
     */
    readonly healthSources: pulumi.Output<string[] | undefined>;
    /**
