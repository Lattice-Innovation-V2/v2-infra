 ...
 */
export declare class SnapshotIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SnapshotIamBindingState, opts?: pulumi.CustomResourceOptions): SnapshotIamBinding;
    /**
     * Returns true if the given object is an instance of SnapshotIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SnapshotIamBinding;
    readonly condition: pulumi.Output<outputs.compute.SnapshotIamBindingCondition | undefined>;
    /**
