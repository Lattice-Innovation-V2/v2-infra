 ...
 * ```
 */
export declare function getMachineImageIamPolicy(args: GetMachineImageIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetMachineImageIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getMachineImageIamPolicyOutput(args: GetMachineImageIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMachineImageIamPolicyResult>;
/**
 * A collection of arguments for invoking getMachineImageIamPolicy.
 */
