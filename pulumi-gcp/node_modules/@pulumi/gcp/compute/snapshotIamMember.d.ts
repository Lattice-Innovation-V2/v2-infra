 ...
 */
export declare class SnapshotIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SnapshotIamMemberState, opts?: pulumi.CustomResourceOptions): SnapshotIamMember;
    /**
     * Returns true if the given object is an instance of SnapshotIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SnapshotIamMember;
    readonly condition: pulumi.Output<outputs.compute.SnapshotIamMemberCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: SnapshotIamMemberArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering SnapshotIamMember resources.
 */
export interface SnapshotIamMemberState {
    condition?: pulumi.Input<inputs.compute.SnapshotIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
