 ...
 * ```
 */
export declare function getRegionSecurityPolicy(args: GetRegionSecurityPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetRegionSecurityPolicyResult>;
/**
 ...
 * ```
 */
export declare function getRegionSecurityPolicyOutput(args: GetRegionSecurityPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetRegionSecurityPolicyResult>;
/**
 * A collection of arguments for invoking getRegionSecurityPolicy.
 */
