...
export declare class ForwardingRule extends pulumi.CustomResource {
     ...
     */
    readonly allowGlobalAccess: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly isMirroringCollector: pulumi.Output<boolean | undefined>;
    /**
     ...
     * @pattern: \d+(?:-\d+)?
     */
    readonly portRange: pulumi.Output<string>;
    /**
     * The `ports`, `portRange`, and `allPorts` fields are mutually exclusive.
     * Only packets addressed to ports in the specified range will be forwarded
     * to the backends configured with this forwarding rule.
     ...
     */
    readonly recreateClosedPsc: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly serviceDirectoryRegistrations: pulumi.Output<outputs.compute.ForwardingRuleServiceDirectoryRegistrations>;
    /**
