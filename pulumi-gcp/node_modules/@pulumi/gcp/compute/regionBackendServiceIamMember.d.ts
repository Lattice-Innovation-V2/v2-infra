...
export declare class RegionBackendServiceIamMember extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionBackendServiceIamMemberState, opts?: pulumi.CustomResourceOptions): RegionBackendServiceIamMember;
    /**
