...
export declare class RegionBackendServiceIamBinding extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionBackendServiceIamBindingState, opts?: pulumi.CustomResourceOptions): RegionBackendServiceIamBinding;
    /**
