 ...
 * ```
 */
export declare class NetworkFirewallPolicyWithRules extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkFirewallPolicyWithRulesState, opts?: pulumi.CustomResourceOptions): NetworkFirewallPolicyWithRules;
    /**
     ...
     */
    static isInstance(obj: any): obj is NetworkFirewallPolicyWithRules;
    /**
     ...
     */
    readonly predefinedRules: pulumi.Output<outputs.compute.NetworkFirewallPolicyWithRulesPredefinedRule[]>;
    /**
     ...
     * Structure is documented below.
     */
    readonly rules: pulumi.Output<outputs.compute.NetworkFirewallPolicyWithRulesRule[]>;
    /**
