...
export declare class NodeTemplate extends pulumi.CustomResource {
     ...
     */
    readonly accelerators: pulumi.Output<outputs.compute.NodeTemplateAccelerator[] | undefined>;
    /**
     * CPU overcommit.
     ...
     * Structure is documented below.
     */
    readonly disks: pulumi.Output<outputs.compute.NodeTemplateDisk[] | undefined>;
    /**
...
export interface NodeTemplateState {
     ...
     * instance scheduling.
     */
    nodeAffinityLabels?: pulumi.Input<{
