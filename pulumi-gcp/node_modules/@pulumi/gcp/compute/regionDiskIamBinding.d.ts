 ...
 */
export declare class RegionDiskIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionDiskIamBindingState, opts?: pulumi.CustomResourceOptions): RegionDiskIamBinding;
    /**
     * Returns true if the given object is an instance of RegionDiskIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegionDiskIamBinding;
    readonly condition: pulumi.Output<outputs.compute.RegionDiskIamBindingCondition | undefined>;
    /**
