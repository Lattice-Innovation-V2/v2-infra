 ...
 */
export declare class StoragePoolIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StoragePoolIamPolicyState, opts?: pulumi.CustomResourceOptions): StoragePoolIamPolicy;
    /**
     * Returns true if the given object is an instance of StoragePoolIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is StoragePoolIamPolicy;
    /**
