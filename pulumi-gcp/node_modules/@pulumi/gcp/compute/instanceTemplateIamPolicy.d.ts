 ...
 */
export declare class InstanceTemplateIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstanceTemplateIamPolicyState, opts?: pulumi.CustomResourceOptions): InstanceTemplateIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is InstanceTemplateIamPolicy;
    /**
 ...
 */
export interface InstanceTemplateIamPolicyState {
    /**
     * (Computed) The etag of the IAM policy.
     */
