 ...
 * ```
 */
export declare class ProjectCloudArmorTier extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ProjectCloudArmorTierState, opts?: pulumi.CustomResourceOptions): ProjectCloudArmorTier;
    /**
     * Returns true if the given object is an instance of ProjectCloudArmorTier.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ProjectCloudArmorTier;
    /**
     * Managed protection tier to be set.
     * Possible values are: `CA_STANDARD`, `CA_ENTERPRISE_PAYGO`, `CA_ENTERPRISE_ANNUAL`.
     */
    readonly cloudArmorTier: pulumi.Output<string>;
    /**
