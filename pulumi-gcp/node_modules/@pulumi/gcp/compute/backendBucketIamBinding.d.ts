 ...
 */
export declare class BackendBucketIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackendBucketIamBindingState, opts?: pulumi.CustomResourceOptions): BackendBucketIamBinding;
    /**
     * Returns true if the given object is an instance of BackendBucketIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BackendBucketIamBinding;
    readonly condition: pulumi.Output<outputs.compute.BackendBucketIamBindingCondition | undefined>;
    /**
