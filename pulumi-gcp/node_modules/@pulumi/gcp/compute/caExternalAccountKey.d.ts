 ...
 */
export declare class CaExternalAccountKey extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CaExternalAccountKeyState, opts?: pulumi.CustomResourceOptions): CaExternalAccountKey;
    /**
     * Returns true if the given object is an instance of CaExternalAccountKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CaExternalAccountKey;
    /**
     * (Deprecated)
     ...
     */
    readonly b64MacKey: pulumi.Output<string>;
    /**
     * (Deprecated)
     * Doubly Base64-URL-encoded HS256 key ('base64(base64(binary key))'). It is generated by the PublicCertificateAuthorityService
     * when the ExternalAccountKey is created.'
     ...
     */
    readonly b64urlMacKey: pulumi.Output<string>;
    /**
     ...
     * **Note**: This property is sensitive and will not be displayed in the plan.
     */
    readonly macKey: pulumi.Output<string>;
    /**
