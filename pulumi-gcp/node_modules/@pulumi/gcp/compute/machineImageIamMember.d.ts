 ...
 */
export declare class MachineImageIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MachineImageIamMemberState, opts?: pulumi.CustomResourceOptions): MachineImageIamMember;
    /**
     * Returns true if the given object is an instance of MachineImageIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MachineImageIamMember;
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
    readonly condition: pulumi.Output<outputs.compute.MachineImageIamMemberCondition | undefined>;
    /**
     ...
     */
    readonly machineImage: pulumi.Output<string>;
    /**
...
export interface MachineImageIamMemberState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.compute.MachineImageIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
