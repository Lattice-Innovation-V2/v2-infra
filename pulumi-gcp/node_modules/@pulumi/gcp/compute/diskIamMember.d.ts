 ...
 */
export declare class DiskIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DiskIamMemberState, opts?: pulumi.CustomResourceOptions): DiskIamMember;
    /**
     * Returns true if the given object is an instance of DiskIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DiskIamMember;
    readonly condition: pulumi.Output<outputs.compute.DiskIamMemberCondition | undefined>;
    /**
