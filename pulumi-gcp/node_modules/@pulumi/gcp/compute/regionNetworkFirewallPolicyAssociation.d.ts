 ...
 * ```
 */
export declare class RegionNetworkFirewallPolicyAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionNetworkFirewallPolicyAssociationState, opts?: pulumi.CustomResourceOptions): RegionNetworkFirewallPolicyAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is RegionNetworkFirewallPolicyAssociation;
    /**
