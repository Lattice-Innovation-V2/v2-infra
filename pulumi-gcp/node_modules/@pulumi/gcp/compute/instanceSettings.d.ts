 ...
 * ```
 */
export declare class InstanceSettings extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InstanceSettingsState, opts?: pulumi.CustomResourceOptions): InstanceSettings;
    /**
     * Returns true if the given object is an instance of InstanceSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InstanceSettings;
    /**
     ...
     */
    readonly metadata: pulumi.Output<outputs.compute.InstanceSettingsMetadata | undefined>;
    /**
