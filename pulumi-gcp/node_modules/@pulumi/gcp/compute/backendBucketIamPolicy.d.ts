 ...
 */
export declare class BackendBucketIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BackendBucketIamPolicyState, opts?: pulumi.CustomResourceOptions): BackendBucketIamPolicy;
    /**
     * Returns true if the given object is an instance of BackendBucketIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is BackendBucketIamPolicy;
    /**
