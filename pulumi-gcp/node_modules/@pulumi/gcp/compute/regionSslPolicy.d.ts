 ...
 * ```
 */
export declare class RegionSslPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionSslPolicyState, opts?: pulumi.CustomResourceOptions): RegionSslPolicy;
    /**
     * Returns true if the given object is an instance of RegionSslPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegionSslPolicy;
    /**
