 ...
 */
export declare class MachineImageIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MachineImageIamPolicyState, opts?: pulumi.CustomResourceOptions): MachineImageIamPolicy;
    /**
     * Returns true if the given object is an instance of MachineImageIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MachineImageIamPolicy;
    /**
