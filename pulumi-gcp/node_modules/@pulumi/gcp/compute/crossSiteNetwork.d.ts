 ...
 * ```
 */
export declare class CrossSiteNetwork extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CrossSiteNetworkState, opts?: pulumi.CustomResourceOptions): CrossSiteNetwork;
    /**
     * Returns true if the given object is an instance of CrossSiteNetwork.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CrossSiteNetwork;
    /**
