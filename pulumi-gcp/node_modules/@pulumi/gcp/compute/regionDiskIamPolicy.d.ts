 ...
 */
export declare class RegionDiskIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionDiskIamPolicyState, opts?: pulumi.CustomResourceOptions): RegionDiskIamPolicy;
    /**
     * Returns true if the given object is an instance of RegionDiskIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegionDiskIamPolicy;
    /**
