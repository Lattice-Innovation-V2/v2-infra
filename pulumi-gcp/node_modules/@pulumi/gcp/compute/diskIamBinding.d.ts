 ...
 */
export declare class DiskIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DiskIamBindingState, opts?: pulumi.CustomResourceOptions): DiskIamBinding;
    /**
     * Returns true if the given object is an instance of DiskIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DiskIamBinding;
    readonly condition: pulumi.Output<outputs.compute.DiskIamBindingCondition | undefined>;
    /**
...
export interface DiskIamBindingState {
    condition?: pulumi.Input<inputs.compute.DiskIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
