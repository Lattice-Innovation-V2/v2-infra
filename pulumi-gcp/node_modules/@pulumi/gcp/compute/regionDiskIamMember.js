...
exports.RegionDiskIamMember = void 0;
 ...
 */
class RegionDiskIamMember extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new RegionDiskIamMember(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(RegionDiskIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
exports.RegionDiskIamMember = RegionDiskIamMember;
/** @internal */
RegionDiskIamMember.__pulumiType = 'gcp:compute/regionDiskIamMember:RegionDiskIamMember';
//# sourceMappingURL=regionDiskIamMember.js.map