 ...
 */
export declare class SnapshotIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SnapshotIamPolicyState, opts?: pulumi.CustomResourceOptions): SnapshotIamPolicy;
    /**
     * Returns true if the given object is an instance of SnapshotIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SnapshotIamPolicy;
    /**
