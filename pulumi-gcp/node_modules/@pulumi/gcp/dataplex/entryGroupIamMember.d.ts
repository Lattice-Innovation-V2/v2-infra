 ...
 */
export declare class EntryGroupIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EntryGroupIamMemberState, opts?: pulumi.CustomResourceOptions): EntryGroupIamMember;
    /**
     * Returns true if the given object is an instance of EntryGroupIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EntryGroupIamMember;
    readonly condition: pulumi.Output<outputs.dataplex.EntryGroupIamMemberCondition | undefined>;
    /**
...
export interface EntryGroupIamMemberState {
    condition?: pulumi.Input<inputs.dataplex.EntryGroupIamMemberCondition>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
