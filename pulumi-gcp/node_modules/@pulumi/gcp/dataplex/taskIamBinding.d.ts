 ...
 */
export declare class TaskIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TaskIamBindingState, opts?: pulumi.CustomResourceOptions): TaskIamBinding;
    /**
     * Returns true if the given object is an instance of TaskIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TaskIamBinding;
    readonly condition: pulumi.Output<outputs.dataplex.TaskIamBindingCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: TaskIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering TaskIamBinding resources.
 */
export interface TaskIamBindingState {
    condition?: pulumi.Input<inputs.dataplex.TaskIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
