 ...
 */
export declare class DatascanIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatascanIamPolicyState, opts?: pulumi.CustomResourceOptions): DatascanIamPolicy;
    /**
     * Returns true if the given object is an instance of DatascanIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatascanIamPolicy;
    /**
