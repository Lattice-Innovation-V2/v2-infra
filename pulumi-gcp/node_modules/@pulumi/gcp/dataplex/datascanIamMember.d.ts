 ...
 */
export declare class DatascanIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DatascanIamMemberState, opts?: pulumi.CustomResourceOptions): DatascanIamMember;
    /**
     * Returns true if the given object is an instance of DatascanIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DatascanIamMember;
    readonly condition: pulumi.Output<outputs.dataplex.DatascanIamMemberCondition | undefined>;
    /**
