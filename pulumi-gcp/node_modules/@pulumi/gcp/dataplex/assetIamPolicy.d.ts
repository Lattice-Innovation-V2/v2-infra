 ...
 */
export declare class AssetIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AssetIamPolicyState, opts?: pulumi.CustomResourceOptions): AssetIamPolicy;
    /**
     * Returns true if the given object is an instance of AssetIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AssetIamPolicy;
    /**
