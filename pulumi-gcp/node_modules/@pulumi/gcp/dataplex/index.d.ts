...
export declare const AspectType: typeof import("./aspectType").AspectType;
...
export declare const AspectTypeIamBinding: typeof import("./aspectTypeIamBinding").AspectTypeIamBinding;
...
export declare const AspectTypeIamMember: typeof import("./aspectTypeIamMember").AspectTypeIamMember;
...
export declare const AspectTypeIamPolicy: typeof import("./aspectTypeIamPolicy").AspectTypeIamPolicy;
...
export declare const AssetIamBinding: typeof import("./assetIamBinding").AssetIamBinding;
...
export declare const AssetIamMember: typeof import("./assetIamMember").AssetIamMember;
...
export declare const DatascanIamBinding: typeof import("./datascanIamBinding").DatascanIamBinding;
...
export declare const DatascanIamMember: typeof import("./datascanIamMember").DatascanIamMember;
...
export declare const DatascanIamPolicy: typeof import("./datascanIamPolicy").DatascanIamPolicy;
export { EntryArgs, EntryState } from "./entry";
export type Entry = import("./entry").Entry;
export declare const Entry: typeof import("./entry").Entry;
export { EntryGroupArgs, EntryGroupState } from "./entryGroup";
export type EntryGroup = import("./entryGroup").EntryGroup;
export declare const EntryGroup: typeof import("./entryGroup").EntryGroup;
...
export declare const EntryGroupIamBinding: typeof import("./entryGroupIamBinding").EntryGroupIamBinding;
...
export declare const EntryGroupIamMember: typeof import("./entryGroupIamMember").EntryGroupIamMember;
...
export declare const EntryGroupIamPolicy: typeof import("./entryGroupIamPolicy").EntryGroupIamPolicy;
export { EntryLinkArgs, EntryLinkState } from "./entryLink";
export type EntryLink = import("./entryLink").EntryLink;
export declare const EntryLink: typeof import("./entryLink").EntryLink;
export { EntryTypeArgs, EntryTypeState } from "./entryType";
export type EntryType = import("./entryType").EntryType;
export declare const EntryType: typeof import("./entryType").EntryType;
...
export declare const EntryTypeIamBinding: typeof import("./entryTypeIamBinding").EntryTypeIamBinding;
...
export declare const EntryTypeIamMember: typeof import("./entryTypeIamMember").EntryTypeIamMember;
...
export declare const EntryTypeIamPolicy: typeof import("./entryTypeIamPolicy").EntryTypeIamPolicy;
...
export declare const getAspectTypeIamPolicy: typeof import("./getAspectTypeIamPolicy").getAspectTypeIamPolicy;
export declare const getAspectTypeIamPolicyOutput: typeof import("./getAspectTypeIamPolicy").getAspectTypeIamPolicyOutput;
export { GetAssetIamPolicyArgs, GetAssetIamPolicyResult, GetAssetIamPolicyOutputArgs } from "./getAssetIamPolicy";
export declare const getAssetIamPolicy: typeof import("./getAssetIamPolicy").getAssetIamPolicy;
export declare const getAssetIamPolicyOutput: typeof import("./getAssetIamPolicy").getAssetIamPolicyOutput;
export { GetDataQualityRulesArgs, GetDataQualityRulesResult, GetDataQualityRulesOutputArgs } from "./getDataQualityRules";
export declare const getDataQualityRules: typeof import("./getDataQualityRules").getDataQualityRules;
export declare const getDataQualityRulesOutput: typeof import("./getDataQualityRules").getDataQualityRulesOutput;
export { GetDatascanIamPolicyArgs, GetDatascanIamPolicyResult, GetDatascanIamPolicyOutputArgs } from "./getDatascanIamPolicy";
export declare const getDatascanIamPolicy: typeof import("./getDatascanIamPolicy").getDatascanIamPolicy;
export declare const getDatascanIamPolicyOutput: typeof import("./getDatascanIamPolicy").getDatascanIamPolicyOutput;
...
export declare const getEntryGroupIamPolicy: typeof import("./getEntryGroupIamPolicy").getEntryGroupIamPolicy;
export declare const getEntryGroupIamPolicyOutput: typeof import("./getEntryGroupIamPolicy").getEntryGroupIamPolicyOutput;
export { GetEntryTypeIamPolicyArgs, GetEntryTypeIamPolicyResult, GetEntryTypeIamPolicyOutputArgs } from "./getEntryTypeIamPolicy";
export declare const getEntryTypeIamPolicy: typeof import("./getEntryTypeIamPolicy").getEntryTypeIamPolicy;
export declare const getEntryTypeIamPolicyOutput: typeof import("./getEntryTypeIamPolicy").getEntryTypeIamPolicyOutput;
export { GetGlossaryIamPolicyArgs, GetGlossaryIamPolicyResult, GetGlossaryIamPolicyOutputArgs } from "./getGlossaryIamPolicy";
export declare const getGlossaryIamPolicy: typeof import("./getGlossaryIamPolicy").getGlossaryIamPolicy;
export declare const getGlossaryIamPolicyOutput: typeof import("./getGlossaryIamPolicy").getGlossaryIamPolicyOutput;
export { GetLakeIamPolicyArgs, GetLakeIamPolicyResult, GetLakeIamPolicyOutputArgs } from "./getLakeIamPolicy";
export declare const getLakeIamPolicy: typeof import("./getLakeIamPolicy").getLakeIamPolicy;
export declare const getLakeIamPolicyOutput: typeof import("./getLakeIamPolicy").getLakeIamPolicyOutput;
export { GetTaskIamPolicyArgs, GetTaskIamPolicyResult, GetTaskIamPolicyOutputArgs } from "./getTaskIamPolicy";
export declare const getTaskIamPolicy: typeof import("./getTaskIamPolicy").getTaskIamPolicy;
export declare const getTaskIamPolicyOutput: typeof import("./getTaskIamPolicy").getTaskIamPolicyOutput;
export { GetZoneIamPolicyArgs, GetZoneIamPolicyResult, GetZoneIamPolicyOutputArgs } from "./getZoneIamPolicy";
export declare const getZoneIamPolicy: typeof import("./getZoneIamPolicy").getZoneIamPolicy;
export declare const getZoneIamPolicyOutput: typeof import("./getZoneIamPolicy").getZoneIamPolicyOutput;
...
export declare const GlossaryCategory: typeof import("./glossaryCategory").GlossaryCategory;
...
export declare const GlossaryIamPolicy: typeof import("./glossaryIamPolicy").GlossaryIamPolicy;
...
export declare const Lake: typeof import("./lake").Lake;
...
export declare const LakeIamBinding: typeof import("./lakeIamBinding").LakeIamBinding;
...
export declare const LakeIamMember: typeof import("./lakeIamMember").LakeIamMember;
...
export declare const LakeIamPolicy: typeof import("./lakeIamPolicy").LakeIamPolicy;
...
export declare const TaskIamBinding: typeof import("./taskIamBinding").TaskIamBinding;
...
export declare const TaskIamMember: typeof import("./taskIamMember").TaskIamMember;
...
export declare const TaskIamPolicy: typeof import("./taskIamPolicy").TaskIamPolicy;
...
export declare const ZoneIamBinding: typeof import("./zoneIamBinding").ZoneIamBinding;
...
export declare const ZoneIamMember: typeof import("./zoneIamMember").ZoneIamMember;
...
export declare const ZoneIamPolicy: typeof import("./zoneIamPolicy").ZoneIamPolicy;
