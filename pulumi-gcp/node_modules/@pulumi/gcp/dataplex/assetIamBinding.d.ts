 ...
 */
export declare class AssetIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AssetIamBindingState, opts?: pulumi.CustomResourceOptions): AssetIamBinding;
    /**
     * Returns true if the given object is an instance of AssetIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AssetIamBinding;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly asset: pulumi.Output<string>;
    readonly condition: pulumi.Output<outputs.dataplex.AssetIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
