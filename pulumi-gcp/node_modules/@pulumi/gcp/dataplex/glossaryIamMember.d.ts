 ...
 */
export declare class GlossaryIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GlossaryIamMemberState, opts?: pulumi.CustomResourceOptions): GlossaryIamMember;
    /**
     * Returns true if the given object is an instance of GlossaryIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GlossaryIamMember;
    readonly condition: pulumi.Output<outputs.dataplex.GlossaryIamMemberCondition | undefined>;
    /**
    ...
    /**
     * Create a GlossaryIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: GlossaryIamMemberArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering GlossaryIamMember resources.
 */
export interface GlossaryIamMemberState {
    condition?: pulumi.Input<inputs.dataplex.GlossaryIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface GlossaryIamMemberArgs {
    condition?: pulumi.Input<inputs.dataplex.GlossaryIamMemberCondition>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
