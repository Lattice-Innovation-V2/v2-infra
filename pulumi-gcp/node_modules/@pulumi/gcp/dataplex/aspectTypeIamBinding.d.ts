 ...
 */
export declare class AspectTypeIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AspectTypeIamBindingState, opts?: pulumi.CustomResourceOptions): AspectTypeIamBinding;
    /**
     * Returns true if the given object is an instance of AspectTypeIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AspectTypeIamBinding;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly aspectTypeId: pulumi.Output<string>;
    readonly condition: pulumi.Output<outputs.dataplex.AspectTypeIamBindingCondition | undefined>;
    /**
