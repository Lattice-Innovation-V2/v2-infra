 ...
 */
export declare class GlossaryIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GlossaryIamPolicyState, opts?: pulumi.CustomResourceOptions): GlossaryIamPolicy;
    /**
     * Returns true if the given object is an instance of GlossaryIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GlossaryIamPolicy;
    /**
