 ...
 */
export declare class EntryTypeIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EntryTypeIamBindingState, opts?: pulumi.CustomResourceOptions): EntryTypeIamBinding;
    /**
     * Returns true if the given object is an instance of EntryTypeIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EntryTypeIamBinding;
    readonly condition: pulumi.Output<outputs.dataplex.EntryTypeIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly entryTypeId: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: EntryTypeIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
