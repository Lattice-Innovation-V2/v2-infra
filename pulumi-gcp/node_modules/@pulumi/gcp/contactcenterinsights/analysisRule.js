...
class AnalysisRule extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new AnalysisRule(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["analysisPercentage"] = state?.analysisPercentage;
...
/** @internal */
AnalysisRule.__pulumiType = 'gcp:contactcenterinsights/analysisRule:AnalysisRule';
//# sourceMappingURL=analysisRule.js.map