...
export declare class Workload extends pulumi.CustomResource {
     ...
     */
    readonly complianceStatuses: pulumi.Output<outputs.assuredworkloads.WorkloadComplianceStatus[]>;
    /**
     ...
     */
    readonly compliantButDisallowedServices: pulumi.Output<string[]>;
    /**
     ...
     */
    readonly ekmProvisioningResponses: pulumi.Output<outputs.assuredworkloads.WorkloadEkmProvisioningResponse[]>;
    /**
     * Optional. Indicates the sovereignty status of the given workload. Currently meant to be used by Europe/Canada customers.
     */
    readonly enableSovereignControls: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly kajEnrollmentState: pulumi.Output<string>;
    /**
     ...
     */
    readonly partnerPermissions: pulumi.Output<outputs.assuredworkloads.WorkloadPartnerPermissions | undefined>;
    /**
     * Optional. Input only. Billing account necessary for purchasing services from Sovereign Partners. This field is required for creating SIA/PSN/CNTXT partner workloads. The caller should have 'billing.resourceAssociations.create' IAM permission on this billing-account. The format of this string is billingAccounts/AAAAAA-BBBBBB-CCCCCC.
     */
    readonly partnerServicesBillingAccount: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly saaEnrollmentResponses: pulumi.Output<outputs.assuredworkloads.WorkloadSaaEnrollmentResponse[]>;
    /**
     * Optional. Indicates whether the e-mail notification for a violation is enabled for a workload. This value will be by default True, and if not present will be considered as true. This should only be updated via updateWorkload call. Any Changes to this field during the createWorkload call will not be honored. This will always be true while creating the workload.
     */
    readonly violationNotificationsEnabled: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly workloadOptions: pulumi.Output<outputs.assuredworkloads.WorkloadWorkloadOptions | undefined>;
    /**
