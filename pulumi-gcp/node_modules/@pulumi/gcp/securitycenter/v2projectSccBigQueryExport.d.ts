 ...
 * ```
 */
export declare class V2ProjectSccBigQueryExport extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V2ProjectSccBigQueryExportState, opts?: pulumi.CustomResourceOptions): V2ProjectSccBigQueryExport;
    /**
     * Returns true if the given object is an instance of V2ProjectSccBigQueryExport.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is V2ProjectSccBigQueryExport;
    /**
    ...
    /**
     * Create a V2ProjectSccBigQueryExport resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: V2ProjectSccBigQueryExportArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering V2ProjectSccBigQueryExport resources.
 */
export interface V2ProjectSccBigQueryExportState {
    /**
     * This must be unique within the organization.
     */
 ...
 */
export interface V2ProjectSccBigQueryExportArgs {
    /**
     * This must be unique within the organization.
     */
    bigQueryExportId: pulumi.Input<string>;
