 ...
 * ```
 */
export declare class ManagementOrganizationSecurityHealthAnalyticsCustomModule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagementOrganizationSecurityHealthAnalyticsCustomModuleState, opts?: pulumi.CustomResourceOptions): ManagementOrganizationSecurityHealthAnalyticsCustomModule;
    /**
     ...
     */
    static isInstance(obj: any): obj is ManagementOrganizationSecurityHealthAnalyticsCustomModule;
    /**
     ...
     */
    readonly customConfig: pulumi.Output<outputs.securitycenter.ManagementOrganizationSecurityHealthAnalyticsCustomModuleCustomConfig | undefined>;
    /**
