...
exports.V2OrganizationSccBigQueryExport = void 0;
 ...
 * ```
 */
class V2OrganizationSccBigQueryExport extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new V2OrganizationSccBigQueryExport(name, state, { ...opts, id: id });
    }
    /**
...
exports.V2OrganizationSccBigQueryExport = V2OrganizationSccBigQueryExport;
/** @internal */
V2OrganizationSccBigQueryExport.__pulumiType = 'gcp:securitycenter/v2OrganizationSccBigQueryExport:V2OrganizationSccBigQueryExport';
//# sourceMappingURL=v2organizationSccBigQueryExport.js.map