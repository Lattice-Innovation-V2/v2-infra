 ...
 * ```
 */
export declare class V2OrganizationSccBigQueryExports extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: V2OrganizationSccBigQueryExportsState, opts?: pulumi.CustomResourceOptions): V2OrganizationSccBigQueryExports;
    /**
     ...
     */
    static isInstance(obj: any): obj is V2OrganizationSccBigQueryExports;
    /**
     ...
     */
    constructor(name: string, args: V2OrganizationSccBigQueryExportsArgs, opts?: pulumi.CustomResourceOptions);
}
/**
