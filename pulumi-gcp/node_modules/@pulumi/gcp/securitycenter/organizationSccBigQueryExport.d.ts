 ...
 * ```
 */
export declare class OrganizationSccBigQueryExport extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrganizationSccBigQueryExportState, opts?: pulumi.CustomResourceOptions): OrganizationSccBigQueryExport;
    /**
     * Returns true if the given object is an instance of OrganizationSccBigQueryExport.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is OrganizationSccBigQueryExport;
    /**
    ...
    /**
     * Create a OrganizationSccBigQueryExport resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: OrganizationSccBigQueryExportArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering OrganizationSccBigQueryExport resources.
 */
export interface OrganizationSccBigQueryExportState {
    /**
     * This must be unique within the organization.
     */
 ...
 */
export interface OrganizationSccBigQueryExportArgs {
    /**
     * This must be unique within the organization.
     */
    bigQueryExportId: pulumi.Input<string>;
