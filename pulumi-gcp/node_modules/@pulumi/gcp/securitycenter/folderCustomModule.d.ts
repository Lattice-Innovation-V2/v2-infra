 ...
 * ```
 */
export declare class FolderCustomModule extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FolderCustomModuleState, opts?: pulumi.CustomResourceOptions): FolderCustomModule;
    /**
     * Returns true if the given object is an instance of FolderCustomModule.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FolderCustomModule;
    /**
     ...
     */
    readonly customConfig: pulumi.Output<outputs.securitycenter.FolderCustomModuleCustomConfig>;
    /**
