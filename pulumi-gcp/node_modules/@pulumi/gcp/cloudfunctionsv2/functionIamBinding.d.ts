...
export declare class FunctionIamBinding extends pulumi.CustomResource {
    ...
    readonly condition: pulumi.Output<outputs.cloudfunctionsv2.FunctionIamBindingCondition | undefined>;
    /**
...
export interface FunctionIamBindingState {
    ...
    condition?: pulumi.Input<inputs.cloudfunctionsv2.FunctionIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
