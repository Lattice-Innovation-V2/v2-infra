 ...
 * ```
 */
export declare class WebResource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebResourceState, opts?: pulumi.CustomResourceOptions): WebResource;
    /**
     * Returns true if the given object is an instance of WebResource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebResource;
    /**
     ...
     */
    readonly site: pulumi.Output<outputs.siteverification.WebResourceSite>;
    /**
     * The verification method for the Site Verification system to use to verify
     * this site or domain.
     * Possible values are: `ANALYTICS`, `DNS_CNAME`, `DNS_TXT`, `FILE`, `META`, `TAG_MANAGER`.
     */
    readonly verificationMethod: pulumi.Output<string>;
    /**
