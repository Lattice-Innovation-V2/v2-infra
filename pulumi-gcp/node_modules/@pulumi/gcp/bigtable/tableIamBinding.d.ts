 ...
 */
export declare class TableIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TableIamBindingState, opts?: pulumi.CustomResourceOptions): TableIamBinding;
    /**
     * Returns true if the given object is an instance of TableIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TableIamBinding;
    readonly condition: pulumi.Output<outputs.bigtable.TableIamBindingCondition | undefined>;
    /**
