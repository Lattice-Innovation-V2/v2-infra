 ...
 */
export declare class TableIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TableIamPolicyState, opts?: pulumi.CustomResourceOptions): TableIamPolicy;
    /**
     * Returns true if the given object is an instance of TableIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TableIamPolicy;
    /**
