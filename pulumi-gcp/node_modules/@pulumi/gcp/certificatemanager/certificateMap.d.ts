 ...
 * ```
 */
export declare class CertificateMap extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CertificateMapState, opts?: pulumi.CustomResourceOptions): CertificateMap;
    /**
     * Returns true if the given object is an instance of CertificateMap.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CertificateMap;
    /**
     ...
     */
    readonly gclbTargets: pulumi.Output<outputs.certificatemanager.CertificateMapGclbTarget[]>;
    /**
