 ...
 * ```
 */
export declare class CertificateIssuanceConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CertificateIssuanceConfigState, opts?: pulumi.CustomResourceOptions): CertificateIssuanceConfig;
    /**
     ...
     */
    static isInstance(obj: any): obj is CertificateIssuanceConfig;
    /**
     * The CA that issues the workload certificate. It includes the CA address, type, authentication to CA service, etc.
     * Structure is documented below.
     */
    readonly certificateAuthorityConfig: pulumi.Output<outputs.certificatemanager.CertificateIssuanceConfigCertificateAuthorityConfig>;
    /**
     ...
     */
    readonly rotationWindowPercentage: pulumi.Output<number>;
    /**
