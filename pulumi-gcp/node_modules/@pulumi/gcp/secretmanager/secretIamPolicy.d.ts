 ...
 */
export declare class SecretIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretIamPolicyState, opts?: pulumi.CustomResourceOptions): SecretIamPolicy;
    /**
     * Returns true if the given object is an instance of SecretIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecretIamPolicy;
    /**
