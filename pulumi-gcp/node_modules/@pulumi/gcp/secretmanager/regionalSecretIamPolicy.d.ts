 ...
 */
export declare class RegionalSecretIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionalSecretIamPolicyState, opts?: pulumi.CustomResourceOptions): RegionalSecretIamPolicy;
    /**
     * Returns true if the given object is an instance of RegionalSecretIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegionalSecretIamPolicy;
    /**
