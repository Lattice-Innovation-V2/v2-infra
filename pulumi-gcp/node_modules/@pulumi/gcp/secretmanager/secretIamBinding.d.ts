 ...
 */
export declare class SecretIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecretIamBindingState, opts?: pulumi.CustomResourceOptions): SecretIamBinding;
    /**
     * Returns true if the given object is an instance of SecretIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecretIamBinding;
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
    readonly condition: pulumi.Output<outputs.secretmanager.SecretIamBindingCondition | undefined>;
    /**
...
export interface SecretIamBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.secretmanager.SecretIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
