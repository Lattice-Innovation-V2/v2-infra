 ...
 * ```
 */
export declare class EnvReferences extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EnvReferencesState, opts?: pulumi.CustomResourceOptions): EnvReferences;
    /**
     * Returns true if the given object is an instance of EnvReferences.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvReferences;
    /**
     ...
     */
    readonly refers: pulumi.Output<string>;
    /**
