...
class DeveloperApp extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new DeveloperApp(name, state, { ...opts, id: id });
    }
    /**
...
exports.DeveloperApp = DeveloperApp;
/** @internal */
DeveloperApp.__pulumiType = 'gcp:apigee/developerApp:DeveloperApp';
