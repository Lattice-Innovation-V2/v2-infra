 ...
 * ```
 */
export declare class SharedflowDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SharedflowDeploymentState, opts?: pulumi.CustomResourceOptions): SharedflowDeployment;
    /**
     * Returns true if the given object is an instance of SharedflowDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SharedflowDeployment;
    /**
     ...
     */
    readonly sharedflowId: pulumi.Output<string>;
    /**
