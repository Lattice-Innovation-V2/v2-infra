 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export declare class EnvironmentIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EnvironmentIamPolicyState, opts?: pulumi.CustomResourceOptions): EnvironmentIamPolicy;
    /**
     * Returns true if the given object is an instance of EnvironmentIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvironmentIamPolicy;
    /**
