 ...
 * ```
 */
export declare class Flowhook extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FlowhookState, opts?: pulumi.CustomResourceOptions): Flowhook;
    /**
     * Returns true if the given object is an instance of Flowhook.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Flowhook;
    /**
     * Flag that specifies whether execution should continue if the flow hook throws an exception. Set to true to continue execution. Set to false to stop execution if the flow hook throws an exception. Defaults to true.
     */
    readonly continueOnError: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    readonly flowHookPoint: pulumi.Output<string>;
    /**
     ...
     */
    readonly sharedflow: pulumi.Output<string>;
    /**
