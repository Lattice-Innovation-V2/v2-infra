 ...
 * ```
 */
export declare class EnvGroupAttachment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EnvGroupAttachmentState, opts?: pulumi.CustomResourceOptions): EnvGroupAttachment;
    /**
     * Returns true if the given object is an instance of EnvGroupAttachment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EnvGroupAttachment;
    /**
     * The Apigee environment group associated with the Apigee environment,
     * in the format `organizations/{{org_name}}/envgroups/{{envgroup_name}}`.
     */
    readonly envgroupId: pulumi.Output<string>;
    /**
