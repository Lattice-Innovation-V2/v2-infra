 ...
 * ```
 */
export declare class SecurityProfileV2 extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityProfileV2State, opts?: pulumi.CustomResourceOptions): SecurityProfileV2;
    /**
     * Returns true if the given object is an instance of SecurityProfileV2.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is SecurityProfileV2;
    /**
     ...
     */
    readonly profileAssessmentConfigs: pulumi.Output<outputs.apigee.SecurityProfileV2ProfileAssessmentConfig[]>;
    /**
