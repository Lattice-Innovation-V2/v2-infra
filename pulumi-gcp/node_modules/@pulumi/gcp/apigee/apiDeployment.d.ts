 ...
 * ```
 */
export declare class ApiDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiDeploymentState, opts?: pulumi.CustomResourceOptions): ApiDeployment;
    /**
     * Returns true if the given object is an instance of ApiDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApiDeployment;
    /**
     ...
     */
    readonly proxyId: pulumi.Output<string>;
    /**
