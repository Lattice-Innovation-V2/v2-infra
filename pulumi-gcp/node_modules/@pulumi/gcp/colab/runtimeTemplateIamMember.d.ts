 ...
 */
export declare class RuntimeTemplateIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RuntimeTemplateIamMemberState, opts?: pulumi.CustomResourceOptions): RuntimeTemplateIamMember;
    /**
     * Returns true if the given object is an instance of RuntimeTemplateIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RuntimeTemplateIamMember;
    readonly condition: pulumi.Output<outputs.colab.RuntimeTemplateIamMemberCondition | undefined>;
    /**
     ...
     */
    readonly runtimeTemplate: pulumi.Output<string>;
    /**
     * Create a RuntimeTemplateIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: RuntimeTemplateIamMemberArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering RuntimeTemplateIamMember resources.
 */
export interface RuntimeTemplateIamMemberState {
    condition?: pulumi.Input<inputs.colab.RuntimeTemplateIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface RuntimeTemplateIamMemberArgs {
    condition?: pulumi.Input<inputs.colab.RuntimeTemplateIamMemberCondition>;
    /**
     * The location for the resource: https://cloud.google.com/colab/docs/locations Used to find the parent resource to bind the IAM policy to. If not specified,
     * the value will be parsed from the identifier of the parent resource. If no location is provided in the parent identifier and no
