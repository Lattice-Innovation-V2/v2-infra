 ...
 * ```
 */
export declare class ClusterUserCreatedConnections extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterUserCreatedConnectionsState, opts?: pulumi.CustomResourceOptions): ClusterUserCreatedConnections;
    /**
     ...
     */
    static isInstance(obj: any): obj is ClusterUserCreatedConnections;
    /**
     * A list of cluster endpoints
     * Structure is documented below.
     */
    readonly clusterEndpoints: pulumi.Output<outputs.redis.ClusterUserCreatedConnectionsClusterEndpoint[] | undefined>;
    /**
