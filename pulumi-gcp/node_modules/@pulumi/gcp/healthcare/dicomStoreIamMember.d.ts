 ...
 */
export declare class DicomStoreIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DicomStoreIamMemberState, opts?: pulumi.CustomResourceOptions): DicomStoreIamMember;
    /**
     * Returns true if the given object is an instance of DicomStoreIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DicomStoreIamMember;
    readonly condition: pulumi.Output<outputs.healthcare.DicomStoreIamMemberCondition | undefined>;
    /**
