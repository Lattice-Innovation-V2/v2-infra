 ...
 */
export declare class DicomStoreIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DicomStoreIamPolicyState, opts?: pulumi.CustomResourceOptions): DicomStoreIamPolicy;
    /**
     * Returns true if the given object is an instance of DicomStoreIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DicomStoreIamPolicy;
    /**
