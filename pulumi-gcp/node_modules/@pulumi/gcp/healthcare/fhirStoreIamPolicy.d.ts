 ...
 */
export declare class FhirStoreIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FhirStoreIamPolicyState, opts?: pulumi.CustomResourceOptions): FhirStoreIamPolicy;
    /**
     * Returns true if the given object is an instance of FhirStoreIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FhirStoreIamPolicy;
    /**
