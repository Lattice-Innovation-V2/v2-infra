 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export declare class ConsentStoreIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConsentStoreIamBindingState, opts?: pulumi.CustomResourceOptions): ConsentStoreIamBinding;
    /**
     * Returns true if the given object is an instance of ConsentStoreIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ConsentStoreIamBinding;
    readonly condition: pulumi.Output<outputs.healthcare.ConsentStoreIamBindingCondition | undefined>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly consentStoreId: pulumi.Output<string>;
    /**
