 ...
 * ```
 */
export declare class TenantInboundSamlConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TenantInboundSamlConfigState, opts?: pulumi.CustomResourceOptions): TenantInboundSamlConfig;
    /**
     * Returns true if the given object is an instance of TenantInboundSamlConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TenantInboundSamlConfig;
    /**
     ...
     */
    readonly idpConfig: pulumi.Output<outputs.identityplatform.TenantInboundSamlConfigIdpConfig>;
    /**
     ...
     * Structure is documented below.
     */
    readonly spConfig: pulumi.Output<outputs.identityplatform.TenantInboundSamlConfigSpConfig>;
    /**
