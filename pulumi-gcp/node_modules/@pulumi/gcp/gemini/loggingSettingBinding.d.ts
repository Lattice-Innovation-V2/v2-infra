 ...
 * ```
 */
export declare class LoggingSettingBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LoggingSettingBindingState, opts?: pulumi.CustomResourceOptions): LoggingSettingBinding;
    /**
     * Returns true if the given object is an instance of LoggingSettingBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LoggingSettingBinding;
    /**
     * Create time stamp.
     */
