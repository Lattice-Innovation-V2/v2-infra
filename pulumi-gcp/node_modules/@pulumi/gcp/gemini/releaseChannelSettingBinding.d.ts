 ...
 * ```
 */
export declare class ReleaseChannelSettingBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReleaseChannelSettingBindingState, opts?: pulumi.CustomResourceOptions): ReleaseChannelSettingBinding;
    /**
     ...
     */
    static isInstance(obj: any): obj is ReleaseChannelSettingBinding;
    /**
     * Create time stamp.
     */
     ...
     * Resource ID segment making up resource `name`. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
     */
    readonly releaseChannelSettingId: pulumi.Output<string>;
    /**
