 ...
 */
export declare class RepositoryGroupIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryGroupIamPolicyState, opts?: pulumi.CustomResourceOptions): RepositoryGroupIamPolicy;
    /**
     * Returns true if the given object is an instance of RepositoryGroupIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RepositoryGroupIamPolicy;
    /**
