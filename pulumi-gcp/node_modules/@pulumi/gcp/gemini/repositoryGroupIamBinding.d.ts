 ...
 */
export declare class RepositoryGroupIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RepositoryGroupIamBindingState, opts?: pulumi.CustomResourceOptions): RepositoryGroupIamBinding;
    /**
     * Returns true if the given object is an instance of RepositoryGroupIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RepositoryGroupIamBinding;
    /**
     * Required. Id of the Code Repository Index. Used to find the parent resource to bind the IAM policy to
     */
    readonly codeRepositoryIndex: pulumi.Output<string>;
    readonly condition: pulumi.Output<outputs.gemini.RepositoryGroupIamBindingCondition | undefined>;
    /**
     ...
     */
    readonly repositoryGroupId: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: RepositoryGroupIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering RepositoryGroupIamBinding resources.
 */
export interface RepositoryGroupIamBindingState {
    /**
     * Required. Id of the Code Repository Index. Used to find the parent resource to bind the IAM policy to
     */
    codeRepositoryIndex?: pulumi.Input<string>;
    condition?: pulumi.Input<inputs.gemini.RepositoryGroupIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface RepositoryGroupIamBindingArgs {
    /**
     * Required. Id of the Code Repository Index. Used to find the parent resource to bind the IAM policy to
     */
    codeRepositoryIndex: pulumi.Input<string>;
