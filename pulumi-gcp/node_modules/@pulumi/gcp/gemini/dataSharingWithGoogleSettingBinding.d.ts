 ...
 * ```
 */
export declare class DataSharingWithGoogleSettingBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataSharingWithGoogleSettingBindingState, opts?: pulumi.CustomResourceOptions): DataSharingWithGoogleSettingBinding;
    /**
     ...
     */
    static isInstance(obj: any): obj is DataSharingWithGoogleSettingBinding;
    /**
     * Create time stamp.
     */
