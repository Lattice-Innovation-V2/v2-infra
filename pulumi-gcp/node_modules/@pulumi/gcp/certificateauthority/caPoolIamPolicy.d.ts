 ...
 */
export declare class CaPoolIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CaPoolIamPolicyState, opts?: pulumi.CustomResourceOptions): CaPoolIamPolicy;
    /**
     * Returns true if the given object is an instance of CaPoolIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CaPoolIamPolicy;
    /**
