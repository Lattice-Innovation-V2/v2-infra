 ...
 */
export declare class CertificateTemplateIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CertificateTemplateIamPolicyState, opts?: pulumi.CustomResourceOptions): CertificateTemplateIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is CertificateTemplateIamPolicy;
    /**
