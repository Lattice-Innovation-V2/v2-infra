 ...
 */
export declare class MembershipIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MembershipIamPolicyState, opts?: pulumi.CustomResourceOptions): MembershipIamPolicy;
    /**
     * Returns true if the given object is an instance of MembershipIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MembershipIamPolicy;
    /**
