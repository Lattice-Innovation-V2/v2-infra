 ...
 */
export declare class FeatureIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FeatureIamBindingState, opts?: pulumi.CustomResourceOptions): FeatureIamBinding;
    /**
     * Returns true if the given object is an instance of FeatureIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FeatureIamBinding;
    readonly condition: pulumi.Output<outputs.gkehub.FeatureIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a FeatureIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: FeatureIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering FeatureIamBinding resources.
 */
export interface FeatureIamBindingState {
    condition?: pulumi.Input<inputs.gkehub.FeatureIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
