 ...
 */
class ScopeIamMember extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new ScopeIamMember(name, state, { ...opts, id: id });
    }
    /**
    ...
    static isInstance(obj) {
        ...
        return obj['__pulumiType'] === ScopeIamMember.__pulumiType;
    }
    constructor(name, argsOrState, opts) {
        ...
        super(ScopeIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
exports.ScopeIamMember = ScopeIamMember;
/** @internal */
ScopeIamMember.__pulumiType = 'gcp:gkehub/scopeIamMember:ScopeIamMember';
//# sourceMappingURL=scopeIamMember.js.map