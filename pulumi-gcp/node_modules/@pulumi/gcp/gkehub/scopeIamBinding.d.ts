 ...
 */
export declare class ScopeIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing ScopeIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScopeIamBindingState, opts?: pulumi.CustomResourceOptions): ScopeIamBinding;
    /**
     * Returns true if the given object is an instance of ScopeIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ScopeIamBinding;
    readonly condition: pulumi.Output<outputs.gkehub.ScopeIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a ScopeIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: ScopeIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering ScopeIamBinding resources.
 */
export interface ScopeIamBindingState {
    condition?: pulumi.Input<inputs.gkehub.ScopeIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface ScopeIamBindingArgs {
    condition?: pulumi.Input<inputs.gkehub.ScopeIamBindingCondition>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
