 ...
 */
export declare class MembershipIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MembershipIamBindingState, opts?: pulumi.CustomResourceOptions): MembershipIamBinding;
    /**
     * Returns true if the given object is an instance of MembershipIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MembershipIamBinding;
    readonly condition: pulumi.Output<outputs.gkehub.MembershipIamBindingCondition | undefined>;
    /**
