 ...
 *     membershipId: "tf-test-membership_85160",
 *     endpoint: {
 *         gkeCluster: {
 ...
 *     dependsOn: [primary],
 * });
 * const scope = new gcp.gkehub.Scope("scope", {scopeId: "tf-test-scope_92130"});
 * const membershipBinding = new gcp.gkehub.MembershipBinding("membership_binding", {
 *     membershipBindingId: "tf-test-membership-binding_16199",
 *     scope: scope.name,
...
class MembershipBinding extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new MembershipBinding(name, state, { ...opts, id: id });
    }
    /**
