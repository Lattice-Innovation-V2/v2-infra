 ...
 */
export declare class FeatureIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FeatureIamPolicyState, opts?: pulumi.CustomResourceOptions): FeatureIamPolicy;
    /**
     * Returns true if the given object is an instance of FeatureIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FeatureIamPolicy;
    /**
