 ...
 * ```
 */
export declare class TagBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TagBindingState, opts?: pulumi.CustomResourceOptions): TagBinding;
    /**
     * Returns true if the given object is an instance of TagBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TagBinding;
    /**
