 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export declare class TagValueIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TagValueIamMemberState, opts?: pulumi.CustomResourceOptions): TagValueIamMember;
    /**
     * Returns true if the given object is an instance of TagValueIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TagValueIamMember;
    readonly condition: pulumi.Output<outputs.tags.TagValueIamMemberCondition | undefined>;
    /**
