 ...
 * ```
 */
export declare class LocationTagBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LocationTagBindingState, opts?: pulumi.CustomResourceOptions): LocationTagBinding;
    /**
     * Returns true if the given object is an instance of LocationTagBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LocationTagBinding;
    /**
