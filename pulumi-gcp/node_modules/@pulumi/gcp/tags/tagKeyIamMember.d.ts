 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export declare class TagKeyIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TagKeyIamMemberState, opts?: pulumi.CustomResourceOptions): TagKeyIamMember;
    /**
     * Returns true if the given object is an instance of TagKeyIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TagKeyIamMember;
    readonly condition: pulumi.Output<outputs.tags.TagKeyIamMemberCondition | undefined>;
    /**
    ...
    /**
     * Create a TagKeyIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: TagKeyIamMemberArgs, opts?: pulumi.CustomResourceOptions);
}
/**
