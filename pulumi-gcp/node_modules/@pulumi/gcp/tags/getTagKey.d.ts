 ...
 * ```
 */
export declare function getTagKey(args: GetTagKeyArgs, opts?: pulumi.InvokeOptions): Promise<GetTagKeyResult>;
/**
 ...
 * ```
 */
export declare function getTagKeyOutput(args: GetTagKeyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTagKeyResult>;
/**
 * A collection of arguments for invoking getTagKey.
 */
