 ...
 */
export declare class AiFeatureOnlineStoreIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureOnlineStoreIamPolicyState, opts?: pulumi.CustomResourceOptions): AiFeatureOnlineStoreIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is AiFeatureOnlineStoreIamPolicy;
    /**
