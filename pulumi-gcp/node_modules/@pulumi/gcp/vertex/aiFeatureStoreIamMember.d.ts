 ...
 */
export declare class AiFeatureStoreIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureStoreIamMemberState, opts?: pulumi.CustomResourceOptions): AiFeatureStoreIamMember;
    /**
     * Returns true if the given object is an instance of AiFeatureStoreIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiFeatureStoreIamMember;
    readonly condition: pulumi.Output<outputs.vertex.AiFeatureStoreIamMemberCondition | undefined>;
    /**
