 ...
 * ```
 */
export declare class AiRagEngineConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiRagEngineConfigState, opts?: pulumi.CustomResourceOptions): AiRagEngineConfig;
    /**
     * Returns true if the given object is an instance of AiRagEngineConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiRagEngineConfig;
    /**
     ...
     */
    readonly ragManagedDbConfig: pulumi.Output<outputs.vertex.AiRagEngineConfigRagManagedDbConfig>;
    /**
