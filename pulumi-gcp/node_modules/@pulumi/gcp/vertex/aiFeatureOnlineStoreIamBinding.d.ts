 ...
 */
export declare class AiFeatureOnlineStoreIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing AiFeatureOnlineStoreIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureOnlineStoreIamBindingState, opts?: pulumi.CustomResourceOptions): AiFeatureOnlineStoreIamBinding;
    /**
     * Returns true if the given object is an instance of AiFeatureOnlineStoreIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiFeatureOnlineStoreIamBinding;
    readonly condition: pulumi.Output<outputs.vertex.AiFeatureOnlineStoreIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a AiFeatureOnlineStoreIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AiFeatureOnlineStoreIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering AiFeatureOnlineStoreIamBinding resources.
 */
export interface AiFeatureOnlineStoreIamBindingState {
    condition?: pulumi.Input<inputs.vertex.AiFeatureOnlineStoreIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface AiFeatureOnlineStoreIamBindingArgs {
    condition?: pulumi.Input<inputs.vertex.AiFeatureOnlineStoreIamBindingCondition>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
