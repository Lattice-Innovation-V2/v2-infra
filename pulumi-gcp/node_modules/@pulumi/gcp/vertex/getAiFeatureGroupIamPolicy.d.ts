 ...
 * ```
 */
export declare function getAiFeatureGroupIamPolicy(args: GetAiFeatureGroupIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetAiFeatureGroupIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getAiFeatureGroupIamPolicyOutput(args: GetAiFeatureGroupIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAiFeatureGroupIamPolicyResult>;
/**
 * A collection of arguments for invoking getAiFeatureGroupIamPolicy.
 */
