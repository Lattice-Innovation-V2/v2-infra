 ...
 * ```
 */
export declare class AiFeatureGroupFeature extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureGroupFeatureState, opts?: pulumi.CustomResourceOptions): AiFeatureGroupFeature;
    /**
     * Returns true if the given object is an instance of AiFeatureGroupFeature.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiFeatureGroupFeature;
    /**
     ...
     */
    readonly versionColumnName: pulumi.Output<string>;
    /**
