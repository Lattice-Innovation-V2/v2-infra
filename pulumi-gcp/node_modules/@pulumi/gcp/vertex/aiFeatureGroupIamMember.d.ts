 ...
 */
export declare class AiFeatureGroupIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureGroupIamMemberState, opts?: pulumi.CustomResourceOptions): AiFeatureGroupIamMember;
    /**
     * Returns true if the given object is an instance of AiFeatureGroupIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiFeatureGroupIamMember;
    readonly condition: pulumi.Output<outputs.vertex.AiFeatureGroupIamMemberCondition | undefined>;
    /**
