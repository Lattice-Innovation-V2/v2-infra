 ...
 * ```
 */
export declare function getAiFeaturestoreIamPolicy(args: GetAiFeaturestoreIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetAiFeaturestoreIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getAiFeaturestoreIamPolicyOutput(args: GetAiFeaturestoreIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAiFeaturestoreIamPolicyResult>;
/**
 * A collection of arguments for invoking getAiFeaturestoreIamPolicy.
 */
