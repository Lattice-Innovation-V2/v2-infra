 ...
 * ```
 */
export declare class AiMetadataStore extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiMetadataStoreState, opts?: pulumi.CustomResourceOptions): AiMetadataStore;
    /**
     * Returns true if the given object is an instance of AiMetadataStore.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiMetadataStore;
    /**
     ...
     * Structure is documented below.
     */
    readonly states: pulumi.Output<outputs.vertex.AiMetadataStoreState[]>;
    /**
