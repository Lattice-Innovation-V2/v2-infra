 ...
 * ```
 */
export declare class AiCacheConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiCacheConfigState, opts?: pulumi.CustomResourceOptions): AiCacheConfig;
    /**
     * Returns true if the given object is an instance of AiCacheConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiCacheConfig;
    /**
     * If set to true, disables GenAI caching. Otherwise caching is enabled.
     */
    readonly disableCache: pulumi.Output<boolean>;
    /**
