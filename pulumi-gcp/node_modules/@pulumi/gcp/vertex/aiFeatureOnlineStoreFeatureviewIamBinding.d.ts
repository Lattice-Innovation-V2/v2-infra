 ...
 */
export declare class AiFeatureOnlineStoreFeatureviewIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AiFeatureOnlineStoreFeatureviewIamBindingState, opts?: pulumi.CustomResourceOptions): AiFeatureOnlineStoreFeatureviewIamBinding;
    /**
     * Returns true if the given object is an instance of AiFeatureOnlineStoreFeatureviewIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AiFeatureOnlineStoreFeatureviewIamBinding;
    readonly condition: pulumi.Output<outputs.vertex.AiFeatureOnlineStoreFeatureviewIamBindingCondition | undefined>;
    /**
     ...
     */
    readonly featureView: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: AiFeatureOnlineStoreFeatureviewIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering AiFeatureOnlineStoreFeatureviewIamBinding resources.
 */
export interface AiFeatureOnlineStoreFeatureviewIamBindingState {
    condition?: pulumi.Input<inputs.vertex.AiFeatureOnlineStoreFeatureviewIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface AiFeatureOnlineStoreFeatureviewIamBindingArgs {
    condition?: pulumi.Input<inputs.vertex.AiFeatureOnlineStoreFeatureviewIamBindingCondition>;
    /**
     * The name of the FeatureOnlineStore to use for the featureview. Used to find the parent resource to bind the IAM policy to
     */
