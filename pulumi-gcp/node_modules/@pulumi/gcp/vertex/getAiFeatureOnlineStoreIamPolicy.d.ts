 ...
 * ```
 */
export declare function getAiFeatureOnlineStoreIamPolicy(args: GetAiFeatureOnlineStoreIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetAiFeatureOnlineStoreIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getAiFeatureOnlineStoreIamPolicyOutput(args: GetAiFeatureOnlineStoreIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAiFeatureOnlineStoreIamPolicyResult>;
/**
 * A collection of arguments for invoking getAiFeatureOnlineStoreIamPolicy.
 */
