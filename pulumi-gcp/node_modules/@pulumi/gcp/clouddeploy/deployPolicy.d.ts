 ...
 * ```
 */
export declare class DeployPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeployPolicyState, opts?: pulumi.CustomResourceOptions): DeployPolicy;
    /**
     * Returns true if the given object is an instance of DeployPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DeployPolicy;
    /**
     ...
     */
    readonly rules: pulumi.Output<outputs.clouddeploy.DeployPolicyRule[]>;
    /**
     ...
     * Structure is documented below.
     */
    readonly selectors: pulumi.Output<outputs.clouddeploy.DeployPolicySelector[]>;
    /**
