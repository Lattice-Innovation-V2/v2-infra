 ...
 */
export declare class IcebergNamespaceIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergNamespaceIamBindingState, opts?: pulumi.CustomResourceOptions): IcebergNamespaceIamBinding;
    /**
     ...
     */
    static isInstance(obj: any): obj is IcebergNamespaceIamBinding;
    /**
     * The name of the IcebergCatalog.
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly catalog: pulumi.Output<string>;
    readonly condition: pulumi.Output<outputs.biglake.IcebergNamespaceIamBindingCondition | undefined>;
    /**
