 ...
 */
export declare class IcebergCatalogIamBinding extends pulumi.CustomResource {
    /**
     * Get an existing IcebergCatalogIamBinding resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergCatalogIamBindingState, opts?: pulumi.CustomResourceOptions): IcebergCatalogIamBinding;
    /**
     * Returns true if the given object is an instance of IcebergCatalogIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IcebergCatalogIamBinding;
    readonly condition: pulumi.Output<outputs.biglake.IcebergCatalogIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a IcebergCatalogIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IcebergCatalogIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering IcebergCatalogIamBinding resources.
 */
export interface IcebergCatalogIamBindingState {
    condition?: pulumi.Input<inputs.biglake.IcebergCatalogIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface IcebergCatalogIamBindingArgs {
    condition?: pulumi.Input<inputs.biglake.IcebergCatalogIamBindingCondition>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
