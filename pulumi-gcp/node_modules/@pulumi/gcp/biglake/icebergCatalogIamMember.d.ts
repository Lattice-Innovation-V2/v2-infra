 ...
 */
export declare class IcebergCatalogIamMember extends pulumi.CustomResource {
    /**
     * Get an existing IcebergCatalogIamMember resource's state with the given name, ID, and optional extra
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergCatalogIamMemberState, opts?: pulumi.CustomResourceOptions): IcebergCatalogIamMember;
    /**
     * Returns true if the given object is an instance of IcebergCatalogIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IcebergCatalogIamMember;
    readonly condition: pulumi.Output<outputs.biglake.IcebergCatalogIamMemberCondition | undefined>;
    /**
    ...
    /**
     * Create a IcebergCatalogIamMember resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: IcebergCatalogIamMemberArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering IcebergCatalogIamMember resources.
 */
export interface IcebergCatalogIamMemberState {
    condition?: pulumi.Input<inputs.biglake.IcebergCatalogIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface IcebergCatalogIamMemberArgs {
    condition?: pulumi.Input<inputs.biglake.IcebergCatalogIamMemberCondition>;
    /**
     * Identities that will be granted the privilege in `role`.
     * Each entry can have one of the following values:
