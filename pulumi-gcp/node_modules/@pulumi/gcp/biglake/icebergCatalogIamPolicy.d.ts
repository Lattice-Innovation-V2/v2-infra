 ...
 */
export declare class IcebergCatalogIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IcebergCatalogIamPolicyState, opts?: pulumi.CustomResourceOptions): IcebergCatalogIamPolicy;
    /**
     * Returns true if the given object is an instance of IcebergCatalogIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is IcebergCatalogIamPolicy;
    /**
