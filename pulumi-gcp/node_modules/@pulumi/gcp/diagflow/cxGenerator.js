...
class CxGenerator extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new CxGenerator(name, state, { ...opts, id: id });
    }
    /**
...
/** @internal */
CxGenerator.__pulumiType = 'gcp:diagflow/cxGenerator:CxGenerator';
//# sourceMappingURL=cxGenerator.js.map