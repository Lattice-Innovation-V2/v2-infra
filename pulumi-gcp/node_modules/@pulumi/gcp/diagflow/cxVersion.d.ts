 ...
 * ```
 */
export declare class CxVersion extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CxVersionState, opts?: pulumi.CustomResourceOptions): CxVersion;
    /**
     * Returns true if the given object is an instance of CxVersion.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CxVersion;
    /**
     ...
     */
    readonly nluSettings: pulumi.Output<outputs.diagflow.CxVersionNluSetting[]>;
    /**
