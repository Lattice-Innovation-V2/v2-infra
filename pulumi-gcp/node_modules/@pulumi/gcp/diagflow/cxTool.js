...
class CxTool extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new CxTool(name, state, { ...opts, id: id });
    }
    /**
...
exports.CxTool = CxTool;
/** @internal */
CxTool.__pulumiType = 'gcp:diagflow/cxTool:CxTool';
//# sourceMappingURL=cxTool.js.map