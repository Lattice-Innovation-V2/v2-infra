 ...
 * ```
 */
export declare class CxEnvironment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CxEnvironmentState, opts?: pulumi.CustomResourceOptions): CxEnvironment;
    /**
     * Returns true if the given object is an instance of CxEnvironment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is CxEnvironment;
    /**
     ...
     */
    readonly versionConfigs: pulumi.Output<outputs.diagflow.CxEnvironmentVersionConfig[]>;
    /**
