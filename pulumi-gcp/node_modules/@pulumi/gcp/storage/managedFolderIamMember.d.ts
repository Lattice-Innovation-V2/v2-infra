 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export declare class ManagedFolderIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedFolderIamMemberState, opts?: pulumi.CustomResourceOptions): ManagedFolderIamMember;
    /**
     * Returns true if the given object is an instance of ManagedFolderIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ManagedFolderIamMember;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.storage.ManagedFolderIamMemberCondition | undefined>;
    /**
     ...
     */
    readonly managedFolder: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: ManagedFolderIamMemberArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering ManagedFolderIamMember resources.
 */
export interface ManagedFolderIamMemberState {
    /**
     * The name of the bucket that contains the managed folder. Used to find the parent resource to bind the IAM policy to
     */
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.storage.ManagedFolderIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface ManagedFolderIamMemberArgs {
    /**
     * The name of the bucket that contains the managed folder. Used to find the parent resource to bind the IAM policy to
     */
    bucket: pulumi.Input<string>;
