...
exports.AttestorIamBinding = void 0;
 ...
 */
class AttestorIamBinding extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new AttestorIamBinding(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(AttestorIamBinding.__pulumiType, name, resourceInputs, opts);
    }
}
exports.AttestorIamBinding = AttestorIamBinding;
/** @internal */
AttestorIamBinding.__pulumiType = 'gcp:binaryauthorization/attestorIamBinding:AttestorIamBinding';
//# sourceMappingURL=attestorIamBinding.js.map