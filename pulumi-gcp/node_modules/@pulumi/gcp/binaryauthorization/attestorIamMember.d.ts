 ...
 */
export declare class AttestorIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AttestorIamMemberState, opts?: pulumi.CustomResourceOptions): AttestorIamMember;
    /**
     * Returns true if the given object is an instance of AttestorIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AttestorIamMember;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly attestor: pulumi.Output<string>;
    readonly condition: pulumi.Output<outputs.binaryauthorization.AttestorIamMemberCondition | undefined>;
    /**
...
export interface AttestorIamMemberState {
    ...
    condition?: pulumi.Input<inputs.binaryauthorization.AttestorIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
