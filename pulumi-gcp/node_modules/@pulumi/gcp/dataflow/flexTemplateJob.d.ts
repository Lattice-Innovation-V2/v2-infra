...
export declare class FlexTemplateJob extends pulumi.CustomResource {
     ...
     */
    readonly additionalExperiments: pulumi.Output<string[]>;
    /**
     * List of pipeline options that should be used by the job. An example value is `["numberOfWorkerHarnessThreads=20"]`.
     */
    readonly additionalPipelineOptions: pulumi.Output<string[] | undefined>;
    /**
     * The algorithm to use for autoscaling.
     */
    readonly autoscalingAlgorithm: pulumi.Output<string>;
    /**
     ...
     */
    readonly enableStreamingEngine: pulumi.Output<boolean | undefined>;
    /**
     * The configuration for VM IPs.  Options are `"WORKER_IP_PUBLIC"` or `"WORKER_IP_PRIVATE"`.
     */
    readonly ipConfiguration: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly launcherMachineType: pulumi.Output<string>;
    /**
     ...
     */
    readonly numWorkers: pulumi.Output<number>;
    /**
     ...
     */
    readonly sdkContainerImage: pulumi.Output<string>;
    /**
     ...
     */
    readonly stagingLocation: pulumi.Output<string>;
    /**
     ...
     */
    readonly tempLocation: pulumi.Output<string>;
    /**
