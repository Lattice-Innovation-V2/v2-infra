 ...
 */
export declare class Datapolicyv2DataPolicyIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Datapolicyv2DataPolicyIamBindingState, opts?: pulumi.CustomResourceOptions): Datapolicyv2DataPolicyIamBinding;
    /**
     * Returns true if the given object is an instance of Datapolicyv2DataPolicyIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Datapolicyv2DataPolicyIamBinding;
    readonly condition: pulumi.Output<outputs.bigquery.Datapolicyv2DataPolicyIamBindingCondition | undefined>;
    /**
     ...
     */
    constructor(name: string, args: Datapolicyv2DataPolicyIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering Datapolicyv2DataPolicyIamBinding resources.
 */
export interface Datapolicyv2DataPolicyIamBindingState {
    condition?: pulumi.Input<inputs.bigquery.Datapolicyv2DataPolicyIamBindingCondition>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
 ...
 */
export interface Datapolicyv2DataPolicyIamBindingArgs {
    condition?: pulumi.Input<inputs.bigquery.Datapolicyv2DataPolicyIamBindingCondition>;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
