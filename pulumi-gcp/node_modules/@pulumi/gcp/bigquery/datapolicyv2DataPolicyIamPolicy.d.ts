 ...
 */
export declare class Datapolicyv2DataPolicyIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Datapolicyv2DataPolicyIamPolicyState, opts?: pulumi.CustomResourceOptions): Datapolicyv2DataPolicyIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is Datapolicyv2DataPolicyIamPolicy;
    /**
