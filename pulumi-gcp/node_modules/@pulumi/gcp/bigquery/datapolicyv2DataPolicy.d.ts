 ...
 * ```
 */
export declare class Datapolicyv2DataPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: Datapolicyv2DataPolicyState, opts?: pulumi.CustomResourceOptions): Datapolicyv2DataPolicy;
    /**
     * Returns true if the given object is an instance of Datapolicyv2DataPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Datapolicyv2DataPolicy;
    /**
     * The policy used to specify data masking rule.
     * Structure is documented below.
     */
    readonly dataMaskingPolicy: pulumi.Output<outputs.bigquery.Datapolicyv2DataPolicyDataMaskingPolicy | undefined>;
    /**
     ...
     */
    readonly grantees: pulumi.Output<string[]>;
    /**
