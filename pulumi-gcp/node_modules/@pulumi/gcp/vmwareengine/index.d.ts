...
export declare const getAnnouncements: typeof import("./getAnnouncements").getAnnouncements;
export declare const getAnnouncementsOutput: typeof import("./getAnnouncements").getAnnouncementsOutput;
...
export declare const getUpgrades: typeof import("./getUpgrades").getUpgrades;
export declare const getUpgradesOutput: typeof import("./getUpgrades").getUpgradesOutput;
