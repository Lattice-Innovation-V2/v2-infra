 ...
 */
export declare class ApiIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiIamBindingState, opts?: pulumi.CustomResourceOptions): ApiIamBinding;
    /**
     * Returns true if the given object is an instance of ApiIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApiIamBinding;
    /**
     * Used to find the parent resource to bind the IAM policy to
     */
    readonly api: pulumi.Output<string>;
    readonly condition: pulumi.Output<outputs.apigateway.ApiIamBindingCondition | undefined>;
    /**
