...
class ApiIamMember extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ApiIamMember(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        super(ApiIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
exports.ApiIamMember = ApiIamMember;
/** @internal */
ApiIamMember.__pulumiType = 'gcp:apigateway/apiIamMember:ApiIamMember';
//# sourceMappingURL=apiIamMember.js.map