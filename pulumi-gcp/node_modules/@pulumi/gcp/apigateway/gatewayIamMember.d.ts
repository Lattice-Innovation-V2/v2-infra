 ...
 */
export declare class GatewayIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GatewayIamMemberState, opts?: pulumi.CustomResourceOptions): GatewayIamMember;
    /**
     * Returns true if the given object is an instance of GatewayIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GatewayIamMember;
    readonly condition: pulumi.Output<outputs.apigateway.GatewayIamMemberCondition | undefined>;
    /**
