 ...
 */
export declare class ApiConfigIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiConfigIamPolicyState, opts?: pulumi.CustomResourceOptions): ApiConfigIamPolicy;
    /**
     * Returns true if the given object is an instance of ApiConfigIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ApiConfigIamPolicy;
    /**
