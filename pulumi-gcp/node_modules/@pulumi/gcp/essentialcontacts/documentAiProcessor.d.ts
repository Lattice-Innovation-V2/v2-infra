 ...
 * ```
 */
export declare class DocumentAiProcessor extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DocumentAiProcessorState, opts?: pulumi.CustomResourceOptions): DocumentAiProcessor;
    /**
     * Returns true if the given object is an instance of DocumentAiProcessor.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DocumentAiProcessor;
    /**
