 ...
 * ```
 */
export declare class MulticloudDataTransferConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MulticloudDataTransferConfigState, opts?: pulumi.CustomResourceOptions): MulticloudDataTransferConfig;
    /**
     ...
     */
    static isInstance(obj: any): obj is MulticloudDataTransferConfig;
    /**
     ...
     */
    readonly destinationsActiveCount: pulumi.Output<number>;
    /**
     * The number of Destination resources configured for the
     * MulticloudDataTransferConfig resource.
     */
    readonly destinationsCount: pulumi.Output<number>;
    /**
     ...
     */
    readonly services: pulumi.Output<outputs.networkconnectivity.MulticloudDataTransferConfigService[] | undefined>;
    /**
