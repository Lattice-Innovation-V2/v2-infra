 ...
 * ```
 */
export declare class RegionalEndpoint extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegionalEndpointState, opts?: pulumi.CustomResourceOptions): RegionalEndpoint;
    /**
     * Returns true if the given object is an instance of RegionalEndpoint.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is RegionalEndpoint;
    /**
     ...
     */
    readonly pscForwardingRule: pulumi.Output<string>;
    /**
     ...
     */
    readonly targetGoogleApi: pulumi.Output<string>;
    /**
