...
class ServiceConnectionPolicy extends pulumi.CustomResource {
    ...
    static get(name, id, state, opts) {
        return new ServiceConnectionPolicy(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["serviceClass"] = state?.serviceClass;
            ...
            if (args?.serviceClass === undefined && !opts.urn) {
            ...
            resourceInputs["serviceClass"] = args?.serviceClass;
