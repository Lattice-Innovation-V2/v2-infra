 ...
 */
export declare class EkmConnectionIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EkmConnectionIamPolicyState, opts?: pulumi.CustomResourceOptions): EkmConnectionIamPolicy;
    /**
     * Returns true if the given object is an instance of EkmConnectionIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is EkmConnectionIamPolicy;
    /**
