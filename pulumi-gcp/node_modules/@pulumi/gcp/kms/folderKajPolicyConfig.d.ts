 ...
 * ```
 */
export declare class FolderKajPolicyConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FolderKajPolicyConfigState, opts?: pulumi.CustomResourceOptions): FolderKajPolicyConfig;
    /**
     * Returns true if the given object is an instance of FolderKajPolicyConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FolderKajPolicyConfig;
    /**
     ...
     */
    readonly defaultKeyAccessJustificationPolicy: pulumi.Output<outputs.kms.FolderKajPolicyConfigDefaultKeyAccessJustificationPolicy | undefined>;
    /**
