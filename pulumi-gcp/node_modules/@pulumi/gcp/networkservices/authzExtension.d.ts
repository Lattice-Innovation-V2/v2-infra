 ...
 * ```
 */
export declare class AuthzExtension extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AuthzExtensionState, opts?: pulumi.CustomResourceOptions): AuthzExtension;
    /**
     * Returns true if the given object is an instance of AuthzExtension.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AuthzExtension;
    /**
     ...
     */
    readonly failOpen: pulumi.Output<boolean>;
    /**
     ...
     */
    readonly forwardHeaders: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    readonly wireFormat: pulumi.Output<string>;
    /**
