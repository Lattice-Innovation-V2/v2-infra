 ...
 * ```
 */
export declare class LbTrafficExtension extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LbTrafficExtensionState, opts?: pulumi.CustomResourceOptions): LbTrafficExtension;
    /**
     * Returns true if the given object is an instance of LbTrafficExtension.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is LbTrafficExtension;
    /**
     ...
     */
    readonly extensionChains: pulumi.Output<outputs.networkservices.LbTrafficExtensionExtensionChain[]>;
    /**
