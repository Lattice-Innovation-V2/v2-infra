 ...
 * ```
 */
export declare class MulticastDomainGroup extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MulticastDomainGroupState, opts?: pulumi.CustomResourceOptions): MulticastDomainGroup;
    /**
     * Returns true if the given object is an instance of MulticastDomainGroup.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MulticastDomainGroup;
    /**
     ...
     */
    readonly multicastDomainGroupId: pulumi.Output<string>;
    /**
     * Multicast domains associated with the group.
     * There can be at most 2 multicast domains in a group.
     */
    readonly multicastDomains: pulumi.Output<string[]>;
    /**
     ...
     * INACTIVE
     */
    readonly states: pulumi.Output<outputs.networkservices.MulticastDomainGroupState[]>;
    /**
