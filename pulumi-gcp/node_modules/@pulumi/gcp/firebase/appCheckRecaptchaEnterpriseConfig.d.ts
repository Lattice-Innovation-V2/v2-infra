 ...
 * ```
 */
export declare class AppCheckRecaptchaEnterpriseConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppCheckRecaptchaEnterpriseConfigState, opts?: pulumi.CustomResourceOptions): AppCheckRecaptchaEnterpriseConfig;
    /**
     ...
     */
    static isInstance(obj: any): obj is AppCheckRecaptchaEnterpriseConfig;
    /**
     * The ID of an
