 ...
 * ```
 */
export declare class ExtensionsInstance extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ExtensionsInstanceState, opts?: pulumi.CustomResourceOptions): ExtensionsInstance;
    /**
     * Returns true if the given object is an instance of ExtensionsInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ExtensionsInstance;
    /**
     * The current Config of the Extension Instance.
     * Structure is documented below.
     */
    readonly config: pulumi.Output<outputs.firebase.ExtensionsInstanceConfig>;
    /**
     ...
     * Structure is documented below.
     */
    readonly errorStatuses: pulumi.Output<outputs.firebase.ExtensionsInstanceErrorStatus[]>;
    /**
     ...
     */
    readonly lastOperationType: pulumi.Output<string>;
    /**
     ...
     * Structure is documented below.
     */
    readonly runtimeDatas: pulumi.Output<outputs.firebase.ExtensionsInstanceRuntimeData[]>;
    /**
