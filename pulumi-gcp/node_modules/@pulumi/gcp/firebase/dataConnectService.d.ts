 ...
 * ```
 */
export declare class DataConnectService extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataConnectServiceState, opts?: pulumi.CustomResourceOptions): DataConnectService;
    /**
     * Returns true if the given object is an instance of DataConnectService.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DataConnectService;
    /**
