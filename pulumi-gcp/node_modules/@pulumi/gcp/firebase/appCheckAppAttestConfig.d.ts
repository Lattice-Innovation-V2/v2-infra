 ...
 * ```
 */
export declare class AppCheckAppAttestConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppCheckAppAttestConfigState, opts?: pulumi.CustomResourceOptions): AppCheckAppAttestConfig;
    /**
     * Returns true if the given object is an instance of AppCheckAppAttestConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AppCheckAppAttestConfig;
    /**
     * The ID of an
