 ...
 * ```
 */
export declare class AppCheckRecaptchaV3Config extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppCheckRecaptchaV3ConfigState, opts?: pulumi.CustomResourceOptions): AppCheckRecaptchaV3Config;
    /**
     ...
     */
    static isInstance(obj: any): obj is AppCheckRecaptchaV3Config;
    /**
     * The ID of an
     ...
     */
    readonly siteSecret: pulumi.Output<string>;
    /**
     ...
     */
    readonly siteSecretSet: pulumi.Output<boolean>;
    /**
