 ...
 * ```
 */
export declare class AndroidApp extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AndroidAppState, opts?: pulumi.CustomResourceOptions): AndroidApp;
    /**
     * Returns true if the given object is an instance of AndroidApp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AndroidApp;
    /**
