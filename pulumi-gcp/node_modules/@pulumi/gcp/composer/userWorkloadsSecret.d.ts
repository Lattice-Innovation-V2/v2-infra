 ...
 * ```
 */
export declare class UserWorkloadsSecret extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserWorkloadsSecretState, opts?: pulumi.CustomResourceOptions): UserWorkloadsSecret;
    /**
     * Returns true if the given object is an instance of UserWorkloadsSecret.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is UserWorkloadsSecret;
    /**
