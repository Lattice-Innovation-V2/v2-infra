 ...
 * ```
 */
export declare class Enrollment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EnrollmentState, opts?: pulumi.CustomResourceOptions): Enrollment;
    /**
     * Returns true if the given object is an instance of Enrollment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is Enrollment;
    /**
     ...
     */
    readonly celMatch: pulumi.Output<string>;
    /**
     * The creation time.
     */
     ...
     * format `^a-z?$`.
     */
    readonly enrollmentId: pulumi.Output<string>;
    /**
     ...
     */
    readonly messageBus: pulumi.Output<string>;
    /**
