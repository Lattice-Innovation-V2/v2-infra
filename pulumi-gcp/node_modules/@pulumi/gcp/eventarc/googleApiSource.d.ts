 ...
 * ```
 */
export declare class GoogleApiSource extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GoogleApiSourceState, opts?: pulumi.CustomResourceOptions): GoogleApiSource;
    /**
     * Returns true if the given object is an instance of GoogleApiSource.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GoogleApiSource;
    /**
     ...
     * the format `^a-z?$`.
     */
    readonly googleApiSourceId: pulumi.Output<string>;
    /**
     * Resource labels.
     ...
     */
    readonly loggingConfig: pulumi.Output<outputs.eventarc.GoogleApiSourceLoggingConfig>;
    /**
