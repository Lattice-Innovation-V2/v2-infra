 ...
 */
export declare class FunctionIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FunctionIamPolicyState, opts?: pulumi.CustomResourceOptions): FunctionIamPolicy;
    /**
     * Returns true if the given object is an instance of FunctionIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FunctionIamPolicy;
    /**
