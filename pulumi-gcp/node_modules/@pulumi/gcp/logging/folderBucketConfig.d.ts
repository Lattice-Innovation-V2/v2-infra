 ...
 * ```
 */
export declare class FolderBucketConfig extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FolderBucketConfigState, opts?: pulumi.CustomResourceOptions): FolderBucketConfig;
    /**
     * Returns true if the given object is an instance of FolderBucketConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is FolderBucketConfig;
    /**
     ...
     */
    readonly cmekSettings: pulumi.Output<outputs.logging.FolderBucketConfigCmekSettings | undefined>;
    /**
     ...
     */
    readonly indexConfigs: pulumi.Output<outputs.logging.FolderBucketConfigIndexConfig[]>;
    /**
