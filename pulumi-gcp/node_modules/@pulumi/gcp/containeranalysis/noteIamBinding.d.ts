 ...
 */
export declare class NoteIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NoteIamBindingState, opts?: pulumi.CustomResourceOptions): NoteIamBinding;
    /**
     * Returns true if the given object is an instance of NoteIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is NoteIamBinding;
    readonly condition: pulumi.Output<outputs.containeranalysis.NoteIamBindingCondition | undefined>;
    /**
