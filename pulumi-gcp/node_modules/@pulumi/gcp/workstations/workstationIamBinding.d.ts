 ...
 */
export declare class WorkstationIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkstationIamBindingState, opts?: pulumi.CustomResourceOptions): WorkstationIamBinding;
    /**
     * Returns true if the given object is an instance of WorkstationIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkstationIamBinding;
    readonly condition: pulumi.Output<outputs.workstations.WorkstationIamBindingCondition | undefined>;
    /**
