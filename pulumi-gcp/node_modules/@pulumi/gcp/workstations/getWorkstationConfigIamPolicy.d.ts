 ...
 * ```
 */
export declare function getWorkstationConfigIamPolicy(args: GetWorkstationConfigIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetWorkstationConfigIamPolicyResult>;
/**
 ...
 * ```
 */
export declare function getWorkstationConfigIamPolicyOutput(args: GetWorkstationConfigIamPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetWorkstationConfigIamPolicyResult>;
/**
 * A collection of arguments for invoking getWorkstationConfigIamPolicy.
 */
