 ...
 */
export declare class WorkstationConfigIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkstationConfigIamPolicyState, opts?: pulumi.CustomResourceOptions): WorkstationConfigIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is WorkstationConfigIamPolicy;
    /**
