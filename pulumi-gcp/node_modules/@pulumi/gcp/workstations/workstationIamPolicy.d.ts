 ...
 */
export declare class WorkstationIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkstationIamPolicyState, opts?: pulumi.CustomResourceOptions): WorkstationIamPolicy;
    /**
     * Returns true if the given object is an instance of WorkstationIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WorkstationIamPolicy;
    /**
