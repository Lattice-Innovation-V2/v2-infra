...
export declare const getRuntimeIamPolicy: typeof import("./getRuntimeIamPolicy").getRuntimeIamPolicy;
export declare const getRuntimeIamPolicyOutput: typeof import("./getRuntimeIamPolicy").getRuntimeIamPolicyOutput;
...
export declare const RuntimeIamBinding: typeof import("./runtimeIamBinding").RuntimeIamBinding;
...
export declare const RuntimeIamMember: typeof import("./runtimeIamMember").RuntimeIamMember;
...
export declare const RuntimeIamPolicy: typeof import("./runtimeIamPolicy").RuntimeIamPolicy;
