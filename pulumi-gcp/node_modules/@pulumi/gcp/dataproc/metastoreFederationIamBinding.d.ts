 ...
 */
export declare class MetastoreFederationIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetastoreFederationIamBindingState, opts?: pulumi.CustomResourceOptions): MetastoreFederationIamBinding;
    /**
     * Returns true if the given object is an instance of MetastoreFederationIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is MetastoreFederationIamBinding;
    readonly condition: pulumi.Output<outputs.dataproc.MetastoreFederationIamBindingCondition | undefined>;
    /**
     ...
     */
    readonly federationId: pulumi.Output<string>;
    /**
     ...
     */
    constructor(name: string, args: MetastoreFederationIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering MetastoreFederationIamBinding resources.
 */
export interface MetastoreFederationIamBindingState {
