 ...
 */
export declare class MetastoreDatabaseIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MetastoreDatabaseIamMemberState, opts?: pulumi.CustomResourceOptions): MetastoreDatabaseIamMember;
    /**
     ...
     */
    static isInstance(obj: any): obj is MetastoreDatabaseIamMember;
    readonly condition: pulumi.Output<outputs.dataproc.MetastoreDatabaseIamMemberCondition | undefined>;
    /**
