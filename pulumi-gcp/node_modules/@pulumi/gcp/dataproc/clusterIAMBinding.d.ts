 ...
 */
export declare class ClusterIAMBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterIAMBindingState, opts?: pulumi.CustomResourceOptions): ClusterIAMBinding;
    /**
     * Returns true if the given object is an instance of ClusterIAMBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ClusterIAMBinding;
    /**
    ...
    readonly condition: pulumi.Output<outputs.dataproc.ClusterIAMBindingCondition | undefined>;
    /**
