 ...
 */
export declare class WebTypeComputeIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebTypeComputeIamPolicyState, opts?: pulumi.CustomResourceOptions): WebTypeComputeIamPolicy;
    /**
     * Returns true if the given object is an instance of WebTypeComputeIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebTypeComputeIamPolicy;
    /**
