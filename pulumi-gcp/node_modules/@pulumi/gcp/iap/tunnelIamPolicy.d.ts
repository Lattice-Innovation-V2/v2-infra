 ...
 */
export declare class TunnelIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TunnelIamPolicyState, opts?: pulumi.CustomResourceOptions): TunnelIamPolicy;
    /**
     * Returns true if the given object is an instance of TunnelIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TunnelIamPolicy;
    /**
     ...
     */
    constructor(name: string, args: TunnelIamPolicyArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering TunnelIamPolicy resources.
 */
export interface TunnelIamPolicyState {
    /**
     * (Computed) The etag of the IAM policy.
     */
 ...
 */
export interface TunnelIamPolicyArgs {
    /**
     * The policy data generated by
     * a `gcp.organizations.getIAMPolicy` data source.
     */
