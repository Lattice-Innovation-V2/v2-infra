 ...
 */
export declare class WebTypeAppEngingIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebTypeAppEngingIamPolicyState, opts?: pulumi.CustomResourceOptions): WebTypeAppEngingIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is WebTypeAppEngingIamPolicy;
    /**
