 ...
 */
export declare class WebBackendServiceIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebBackendServiceIamPolicyState, opts?: pulumi.CustomResourceOptions): WebBackendServiceIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is WebBackendServiceIamPolicy;
    /**
