 ...
 */
export declare class WebCloudRunServiceIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebCloudRunServiceIamPolicyState, opts?: pulumi.CustomResourceOptions): WebCloudRunServiceIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is WebCloudRunServiceIamPolicy;
    /**
