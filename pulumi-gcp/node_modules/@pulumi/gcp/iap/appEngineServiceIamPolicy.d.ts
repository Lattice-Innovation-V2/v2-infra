 ...
 */
export declare class AppEngineServiceIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppEngineServiceIamPolicyState, opts?: pulumi.CustomResourceOptions): AppEngineServiceIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is AppEngineServiceIamPolicy;
    /**
