 ...
 */
export declare class TunnelDestGroupIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TunnelDestGroupIamPolicyState, opts?: pulumi.CustomResourceOptions): TunnelDestGroupIamPolicy;
    /**
     * Returns true if the given object is an instance of TunnelDestGroupIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TunnelDestGroupIamPolicy;
    /**
