...
exports.WebBackendServiceIamMember = void 0;
 ...
 */
class WebBackendServiceIamMember extends pulumi.CustomResource {
    /**
    ...
    static get(name, id, state, opts) {
        return new WebBackendServiceIamMember(name, state, { ...opts, id: id });
    }
    /**
    ...
    constructor(name, argsOrState, opts) {
        ...
        if (opts.id) {
            ...
            resourceInputs["webBackendService"] = state?.webBackendService;
        }
        else {
            ...
            if (args?.webBackendService === undefined && !opts.urn) {
            ...
            resourceInputs["webBackendService"] = args?.webBackendService;
            resourceInputs["etag"] = undefined /*out*/;
        }
        opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
        super(WebBackendServiceIamMember.__pulumiType, name, resourceInputs, opts);
    }
}
exports.WebBackendServiceIamMember = WebBackendServiceIamMember;
/** @internal */
WebBackendServiceIamMember.__pulumiType = 'gcp:iap/webBackendServiceIamMember:WebBackendServiceIamMember';
//# sourceMappingURL=webBackendServiceIamMember.js.map