 ...
 */
export declare class WebTypeAppEngingIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebTypeAppEngingIamMemberState, opts?: pulumi.CustomResourceOptions): WebTypeAppEngingIamMember;
    /**
     ...
     */
    static isInstance(obj: any): obj is WebTypeAppEngingIamMember;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.iap.WebTypeAppEngingIamMemberCondition | undefined>;
    /**
