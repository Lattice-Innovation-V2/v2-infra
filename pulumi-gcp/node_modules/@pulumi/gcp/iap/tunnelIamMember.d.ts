 ...
 */
export declare class TunnelIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TunnelIamMemberState, opts?: pulumi.CustomResourceOptions): TunnelIamMember;
    /**
     * Returns true if the given object is an instance of TunnelIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TunnelIamMember;
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
    readonly condition: pulumi.Output<outputs.iap.TunnelIamMemberCondition | undefined>;
    /**
...
export interface TunnelIamMemberState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.TunnelIamMemberCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
