 ...
 */
export declare class TunnelInstanceIAMPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TunnelInstanceIAMPolicyState, opts?: pulumi.CustomResourceOptions): TunnelInstanceIAMPolicy;
    /**
     * Returns true if the given object is an instance of TunnelInstanceIAMPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is TunnelInstanceIAMPolicy;
    /**
