 ...
 */
export declare class WebTypeAppEngingIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebTypeAppEngingIamBindingState, opts?: pulumi.CustomResourceOptions): WebTypeAppEngingIamBinding;
    /**
     ...
     */
    static isInstance(obj: any): obj is WebTypeAppEngingIamBinding;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.iap.WebTypeAppEngingIamBindingCondition | undefined>;
    /**
