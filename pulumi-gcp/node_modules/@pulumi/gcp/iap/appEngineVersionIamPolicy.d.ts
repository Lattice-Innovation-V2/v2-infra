 ...
 */
export declare class AppEngineVersionIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppEngineVersionIamPolicyState, opts?: pulumi.CustomResourceOptions): AppEngineVersionIamPolicy;
    /**
     ...
     */
    static isInstance(obj: any): obj is AppEngineVersionIamPolicy;
    /**
