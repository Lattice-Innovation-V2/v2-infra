 ...
 */
export declare class AppEngineServiceIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppEngineServiceIamBindingState, opts?: pulumi.CustomResourceOptions): AppEngineServiceIamBinding;
    /**
     ...
     */
    static isInstance(obj: any): obj is AppEngineServiceIamBinding;
    /**
     ...
     */
    readonly condition: pulumi.Output<outputs.iap.AppEngineServiceIamBindingCondition | undefined>;
    /**
