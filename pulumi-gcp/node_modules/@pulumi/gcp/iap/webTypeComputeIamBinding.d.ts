 ...
 */
export declare class WebTypeComputeIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebTypeComputeIamBindingState, opts?: pulumi.CustomResourceOptions): WebTypeComputeIamBinding;
    /**
     * Returns true if the given object is an instance of WebTypeComputeIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is WebTypeComputeIamBinding;
    /**
     * An [IAM Condition](https://cloud.google.com/iam/docs/conditions-overview) for a given binding.
     * Structure is documented below.
     */
    readonly condition: pulumi.Output<outputs.iap.WebTypeComputeIamBindingCondition | undefined>;
    /**
...
export interface WebTypeComputeIamBindingState {
     ...
     * Structure is documented below.
     */
    condition?: pulumi.Input<inputs.iap.WebTypeComputeIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
