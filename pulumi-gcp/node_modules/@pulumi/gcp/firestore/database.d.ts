...
export declare class Database extends pulumi.CustomResource {
     ...
     */
    readonly cmekConfig: pulumi.Output<outputs.firestore.DatabaseCmekConfig | undefined>;
    /**
     ...
     */
    readonly deleteProtectionState: pulumi.Output<string>;
    /**
     ...
     */
    readonly earliestVersionTime: pulumi.Output<string>;
    /**
     ...
     */
    readonly firestoreDataAccessMode: pulumi.Output<string>;
    /**
     ...
     * Possible values are: `DATA_ACCESS_MODE_ENABLED`, `DATA_ACCESS_MODE_DISABLED`.
     */
    readonly mongodbCompatibleDataAccessMode: pulumi.Output<string>;
    /**
     ...
     */
    readonly pointInTimeRecoveryEnablement: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly realtimeUpdatesMode: pulumi.Output<string>;
    /**
...
export interface DatabaseState {
     ...
     * Possible values are: `DATA_ACCESS_MODE_ENABLED`, `DATA_ACCESS_MODE_DISABLED`.
     */
    firestoreDataAccessMode?: pulumi.Input<string>;
    /**
     * Output only. The keyPrefix for this database.
     * This keyPrefix is used, in combination with the project id ("~") to construct the application id
     * that is returned from the Cloud Datastore APIs in Google App Engine first generation runtimes.
     ...
     * Possible values are: `DATA_ACCESS_MODE_ENABLED`, `DATA_ACCESS_MODE_DISABLED`.
     */
    mongodbCompatibleDataAccessMode?: pulumi.Input<string>;
    /**
     * The ID to use for the database, which will become the final
     * component of the database's resource name. This value should be 4-63
     * characters. Valid characters are /[a-z][0-9]-/ with first character
     ...
     * Possible values are: `REALTIME_UPDATES_MODE_ENABLED`, `REALTIME_UPDATES_MODE_DISABLED`.
     */
    realtimeUpdatesMode?: pulumi.Input<string>;
    /**
     * Input only. A map of resource manager tags. Resource manager tag keys
     * and values have the same definition as resource manager tags.
     * Keys must be in the format tagKeys/{tag_key_id}, and values are in the format tagValues/456.
