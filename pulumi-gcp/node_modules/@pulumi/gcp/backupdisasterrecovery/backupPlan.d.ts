...
export declare class BackupPlan extends pulumi.CustomResource {
     ...
     */
    readonly backupRules: pulumi.Output<outputs.backupdisasterrecovery.BackupPlanBackupRule[]>;
    /**
     * Backup vault where the backups gets stored using this Backup plan.
     */
    readonly backupVault: pulumi.Output<string>;
    /**
     * The Google Cloud Platform Service Account to be used by the BackupVault for taking backups.
     */
    readonly backupVaultServiceAccount: pulumi.Output<string>;
    /**
     ...
     */
    readonly logRetentionDays: pulumi.Output<number | undefined>;
    /**
     * The maximum number of days for which an on-demand backup taken with custom retention can be retained.
     */
    readonly maxCustomOnDemandRetentionDays: pulumi.Output<number | undefined>;
    /**
     ...
     */
    readonly supportedResourceTypes: pulumi.Output<string[]>;
    /**
