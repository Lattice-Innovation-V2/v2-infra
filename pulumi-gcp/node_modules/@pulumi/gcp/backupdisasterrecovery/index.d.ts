...
export declare const getBackupPlanAssociations: typeof import("./getBackupPlanAssociations").getBackupPlanAssociations;
export declare const getBackupPlanAssociationsOutput: typeof import("./getBackupPlanAssociations").getBackupPlanAssociationsOutput;
...
export declare const getDataSourceReference: typeof import("./getDataSourceReference").getDataSourceReference;
export declare const getDataSourceReferenceOutput: typeof import("./getDataSourceReference").getDataSourceReferenceOutput;
...
export declare const getDataSourceReferences: typeof import("./getDataSourceReferences").getDataSourceReferences;
export declare const getDataSourceReferencesOutput: typeof import("./getDataSourceReferences").getDataSourceReferencesOutput;
export { GetDataSourcesArgs, GetDataSourcesResult, GetDataSourcesOutputArgs } from "./getDataSources";
export declare const getDataSources: typeof import("./getDataSources").getDataSources;
export declare const getDataSourcesOutput: typeof import("./getDataSources").getDataSourcesOutput;
...
export declare const RestoreWorkload: typeof import("./restoreWorkload").RestoreWorkload;
