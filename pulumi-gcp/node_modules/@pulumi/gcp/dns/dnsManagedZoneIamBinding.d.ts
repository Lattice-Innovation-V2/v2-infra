 ...
 */
export declare class DnsManagedZoneIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DnsManagedZoneIamBindingState, opts?: pulumi.CustomResourceOptions): DnsManagedZoneIamBinding;
    /**
     * Returns true if the given object is an instance of DnsManagedZoneIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DnsManagedZoneIamBinding;
    readonly condition: pulumi.Output<outputs.dns.DnsManagedZoneIamBindingCondition | undefined>;
    /**
