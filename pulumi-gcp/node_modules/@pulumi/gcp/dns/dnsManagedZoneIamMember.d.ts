 ...
 */
export declare class DnsManagedZoneIamMember extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DnsManagedZoneIamMemberState, opts?: pulumi.CustomResourceOptions): DnsManagedZoneIamMember;
    /**
     * Returns true if the given object is an instance of DnsManagedZoneIamMember.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is DnsManagedZoneIamMember;
    readonly condition: pulumi.Output<outputs.dns.DnsManagedZoneIamMemberCondition | undefined>;
    /**
