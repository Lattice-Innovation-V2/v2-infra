...
export declare const DnsThreatDetector: typeof import("./dnsThreatDetector").DnsThreatDetector;
...
export declare const MirroringEndpoint: typeof import("./mirroringEndpoint").MirroringEndpoint;
...
export declare const SacAttachment: typeof import("./sacAttachment").SacAttachment;
export { SacRealmArgs, SacRealmState } from "./sacRealm";
export type SacRealm = import("./sacRealm").SacRealm;
export declare const SacRealm: typeof import("./sacRealm").SacRealm;
