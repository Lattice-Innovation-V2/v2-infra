 ...
 * ```
 */
export declare class InterceptEndpointGroupAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterceptEndpointGroupAssociationState, opts?: pulumi.CustomResourceOptions): InterceptEndpointGroupAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is InterceptEndpointGroupAssociation;
    /**
     ...
     */
    readonly interceptEndpointGroup: pulumi.Output<string>;
    /**
     * The ID to use for the new association, which will become the final
     * component of the endpoint group's resource name. If not provided, the
     * server will generate a unique ID.
     */
    readonly interceptEndpointGroupAssociationId: pulumi.Output<string | undefined>;
    /**
     ...
     */
    readonly locations: pulumi.Output<outputs.networksecurity.InterceptEndpointGroupAssociationLocation[]>;
    /**
     * (Deprecated)
     ...
     */
    readonly locationsDetails: pulumi.Output<outputs.networksecurity.InterceptEndpointGroupAssociationLocationsDetail[]>;
    /**
