 ...
 */
export declare class AddressGroupIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AddressGroupIamPolicyState, opts?: pulumi.CustomResourceOptions): AddressGroupIamPolicy;
    /**
     * Returns true if the given object is an instance of AddressGroupIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AddressGroupIamPolicy;
    /**
