 ...
 */
export declare class AddressGroupIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AddressGroupIamBindingState, opts?: pulumi.CustomResourceOptions): AddressGroupIamBinding;
    /**
     * Returns true if the given object is an instance of AddressGroupIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AddressGroupIamBinding;
    readonly condition: pulumi.Output<outputs.networksecurity.AddressGroupIamBindingCondition | undefined>;
    /**
    ...
    /**
     * Create a AddressGroupIamBinding resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: AddressGroupIamBindingArgs, opts?: pulumi.CustomResourceOptions);
}
/**
 * Input properties used for looking up and filtering AddressGroupIamBinding resources.
 */
export interface AddressGroupIamBindingState {
    condition?: pulumi.Input<inputs.networksecurity.AddressGroupIamBindingCondition>;
    /**
     * (Computed) The etag of the IAM policy.
     */
