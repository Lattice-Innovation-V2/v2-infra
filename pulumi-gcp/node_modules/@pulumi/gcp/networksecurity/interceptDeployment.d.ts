 ...
 * ```
 */
export declare class InterceptDeployment extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: InterceptDeploymentState, opts?: pulumi.CustomResourceOptions): InterceptDeployment;
    /**
     * Returns true if the given object is an instance of InterceptDeployment.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is InterceptDeployment;
    /**
     ...
     */
    readonly interceptDeploymentId: pulumi.Output<string>;
    /**
