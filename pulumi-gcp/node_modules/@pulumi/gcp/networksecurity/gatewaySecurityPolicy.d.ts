 ...
 * ```
 */
export declare class GatewaySecurityPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GatewaySecurityPolicyState, opts?: pulumi.CustomResourceOptions): GatewaySecurityPolicy;
    /**
     * Returns true if the given object is an instance of GatewaySecurityPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is GatewaySecurityPolicy;
    /**
