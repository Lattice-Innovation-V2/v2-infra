 ...
 *  full name of the custom role, e.g. `[projects/my-project|organizations/my-org]/roles/my-custom-role`.
 */
export declare class AccessPolicyIamBinding extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AccessPolicyIamBindingState, opts?: pulumi.CustomResourceOptions): AccessPolicyIamBinding;
    /**
     * Returns true if the given object is an instance of AccessPolicyIamBinding.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is AccessPolicyIamBinding;
    readonly condition: pulumi.Output<outputs.accesscontextmanager.AccessPolicyIamBindingCondition | undefined>;
    /**
